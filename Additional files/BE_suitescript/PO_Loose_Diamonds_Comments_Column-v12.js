...
function setPOCommentsCol(type)
{
	if(type=="create" || type=="specialorder")
	{
		...
		try
		{
			...
			//Check to see if PO is to GM Casting House Inc (153) or Unique New York (7773) or Miracleworks (442500) or Harout (1223843)
			if(vendorID!=153 && vendorID!=7773 && vendorID!=442500 && vendorID!=1223843)
				return true
		...
		try
		{
			...
			filters[2] = new nlobjSearchFilter("custitem20", "item", "anyof", [7,8,15,18])
		...
		try
		{
			...
			else if(itemCategory==8 || itemCategory==15 || itemCategory==18)
			{
