function bindToBeReturnedList(form, obj_result, number_of_result) {
    ...
    sublistToBeReturn.addField('custpage_vendor_ret_status_custpage_to_be_returned', 'select', 'Vendor Return Status','customlist539');//customlist539
    sublistToBeReturn.addField('custpage_vendor_ret_status_hidden_custpage_to_be_returned', 'text', 'Vendor Return Status Hidden');
    ...
    if (results) {
        ...
        try {
            ...
            for (var i = 0; i < results.length; i++) {
              ...
              reasonForDiamondRet=results[i].getValue(col[31]);
              ...
              if(date_on_hold_through>=todays_date)
                ...
                sublistToBeReturn_Arr.push({
                  custpage_chk_req_to_inv_custpage_to_be_returned:'<span  name="'+name_id+'"    '+style_check_box+' id="custpage_chk_req_to_inv_'+(i+1)+'" class="checkbox_unck" onclick="NLCheckboxOnClick(this);"><input type="checkbox" class="checkbox" ><img class="checkboximage" src="/images/nav/ns_x.gif" alt=""></span>',
                    ...
                    custpage_vendor_ret_status_custpage_to_be_returned: results[i].getValue(col[32]),
                  	custpage_vendor_ret_status_hidden_custpage_to_be_returned:results[i].getValue(col[32]),
					custpage_gemstone_status_custpage_to_be_returned: '4',
                  	custpage_gemstone_status_hidden_custpage_to_be_returned: '4',
                    custpage_reason_for_diamd_ret_custpage_to_be_returned: reasonForDiamondRet,
                  	custpage_reason_for_diamd_ret_hidden_custpage_to_be_returned: reasonForDiamondRet,
					...
					custpage_days_since_org_rec_custpage_to_be_returned: results[i].getValue(col[11]),
