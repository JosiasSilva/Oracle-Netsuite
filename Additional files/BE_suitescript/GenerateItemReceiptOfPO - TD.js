 ...
 * Script URL : /app/common/scripting/script.nl?id=1022
 * Button URL : /app/site/hosting/scriptlet.nl?script=1022&deploy=1
 * Save Search URL : /app/common/search/searchresults.nl?searchid=4727
 */

//Create a Suitelet Script that generate an Item Receipt
/*function GenerateItemReceipt(request,response)
{
	var form = nlapiCreateForm("Create Item Receipt of POs for TD");
...
function GenerateItemReceipt(request, response)
{
	...
	else if(request.getMethod() == 'POST')
	{
                ...
                params['custscript_savedsearch_id7'] = 4727;
		var result = nlapiScheduleScript('customscript1060', 'customdeploy1',params);  // 1060 is internal id of the scheduled script that you wish to reschedule and 1 is deployment id
