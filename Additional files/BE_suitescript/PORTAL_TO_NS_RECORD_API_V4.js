...
function UpdateRecord(datain)
{
	...
	var diamondStatus = "";
  	nlapiLogExecution('DEBUG',"Portal json data is : ", JSON.stringify(datain));
    ...
    try
    {
        ...
        cdpObj.setFieldValue("custrecord165",datain.portal_request_type); //Added by ajay 28April 2017
