function updateLPPFields(type,form)
{
	if(type=="view")
	{
		try
		{
			//Check to verify running on parent
			var hasParent = nlapiGetNewRecord().getFieldValue("parent");
			if(hasParent!=null && hasParent!="")
				return true;
			
			var parentItem = nlapiGetRecordId();
			...
			if(results!=null)
			{
				...
				nlapiSetFieldValue("custitem_last_purch_price_18kw_nocad",results[0].getValue("rate","transaction"));
			}
			else			
			{
			...
			{
				nlapiLogExecution("debug","Rate",results[0].getValue("rate","transaction"))
				nlapiSetFieldValue("custitem_last_purch_price_pt_nocad",results[0].getValue("rate","transaction"));
			}
			else			
			{
				nlapiLogExecution("debug","No results found...")
			...
			{
				nlapiLogExecution("debug","Rate",results[0].getValue("rate","transaction"))
				nlapiSetFieldValue("custitem_last_purch_price_18kw_cad",results[0].getValue("rate","transaction"));
			}
			else			
			{
				nlapiLogExecution("debug","No results found...")
			...
			{
				nlapiLogExecution("debug","Rate",results[0].getValue("rate","transaction"))
				nlapiSetFieldValue("custitem_last_purch_price_pt_cad",results[0].getValue("rate","transaction"));
			}
			else			
			{
				nlapiLogExecution("debug","No results found...")
			...
			if(results!=null)
			{
				...
				nlapiSetFieldValue("custitem_avg_purch_price_18kw",results[0].getValue("rate",null,"avg"));
			}
			else			
			{
				nlapiLogExecution("debug","No results found...")
			...
			{
				nlapiLogExecution("debug","Rate",results[0].getValue("rate",null,"avg"))
				nlapiSetFieldValue("custitem_avg_purch_price_pt",results[0].getValue("rate",null,"avg"));
			}
			else			
			{
				nlapiLogExecution("debug","No results found...")
