...
function syncPhoneCallFieldToCustomer() {
    ...
    try {
        ...
        //Add Filters
        filters.push(new nlobjSearchFilter('formulatext', null, 'isnotempty', null).setFormula('{company}'));
        filters.push(new nlobjSearchFilter('custeventcontiviocontactresult', null, 'is', 'SUCCESS'));
 	    filters.push(new nlobjSearchFilter('createddate', null, 'on', 'today'));
        //var search=nlapiLoadSearch(null,9394);
