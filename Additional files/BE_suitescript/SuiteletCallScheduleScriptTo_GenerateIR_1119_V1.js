...
function CreateItemReceipt()
{
	try
	{
	    ...
	    var searchId = nlapiGetContext().getSetting('SCRIPT','custscript_savedsearch_id_guild_facet');
	    ...
	    if ( searchresults == null )
	     ...
	     var reschedulePoint = nlapiGetContext().getSetting('SCRIPT','custscript_reschedule_point_guild_facet');
	     reschedulePoint = (reschedulePoint!=null && reschedulePoint!=undefined) ? parseInt(reschedulePoint) : 0;
	     nlapiLogExecution("debug","Starting Point is :",reschedulePoint);
	    ...
	    for ( var i = reschedulePoint; i < searchresults.length; i++ )
	    {
		    ...
		    {
                                nlapiLogExecution("debug","Rescheduling Point is :",i);
                                var params = new Array();
                                params['custscript_reschedule_point_guild_facet'] = i;
