//var scriptId = "2133";
function Diamond_Portal_Logic_Rewrite_Push_To_Portal_For_Create_Invoice_By_WorkFlow(cdpId,type,recordType,scriptId) 
{
  try 
  {
    ...
    if(cdpId)
    {
      ...
      if(override_mapping_logic=='F')
      {
        ...
        else if (group == 'B' || group_b == 'T') 
        {
          ...
          if ( (request_type == 1 || request_type == 8) && diamond_status == 1 && (new_bill_date == null || new_bill_date == '')) // for point 1
          {
            portal_request_type = 3;//Sold
            item_status = 2;//Confirmed
          ...
          else if (request_type == 7 && diamond_status == 1 && cs_status == 4 && (new_bill_date == null || new_bill_date == '')) // for point 2
          {
            portal_request_type = 3;//Sold
            item_status = 2;//Confirmed
            action_needed =4;//Ready to Invoice
