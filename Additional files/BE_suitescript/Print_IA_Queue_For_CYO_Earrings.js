 ...
 * FILE NAME   			:	Print_IA_Queue_For_CYO_Earrings.js
 ...
 * File URL Sandbox		: https://debugger.sandbox.netsuite.com/app/common/media/mediaitem.nl?uploadrectype=script&id=22328835
 * File URL	Production  :
 */

function Print_IA_Queue_CYO_Earrings(order,currency,today,customer_name,print_ia_queue_for_earrings_pendants)
{
  ...
  {
    return Print_IA_Queue_CYO_Earrings_Arr(order,currency,today,customer_name,print_ia_queue_for_earrings_pendants,tempPageData);
  }
  else 
    return tempPageData;
}
function Print_IA_Queue_CYO_Earrings_Arr(order,currency,today,customer_name,print_ia_queue_for_earrings_pendants,tempPageData)
{
  ...
  if(cyo_earrings_pdf_arr.length>0)
  {
    ...
    tempPageData.push(print_ia_queue_for_earrings_pendants(cyo_earrings_pdf_json_obj));
  }
  return tempPageData;
}