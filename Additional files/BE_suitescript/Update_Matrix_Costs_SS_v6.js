...
function updateItemPricing(itemObj,startAt,currentLine)
{
	try
	{
		...
		item.cost_18kw_pref = calcPreferredVendor(parseFloat(item.cost_18kw_ch),parseFloat(item.cost_18kw_usny),parseFloat(item.cost_18kw_sasha));
		item.cost_18ky_pref = calcPreferredVendor(parseFloat(item.cost_18ky_ch),parseFloat(item.cost_18ky_usny),parseFloat(item.cost_18ky_sasha));
		item.cost_platinum_pref = calcPreferredVendor(parseFloat(item.cost_platinum_ch),parseFloat(item.cost_platinum_usny),parseFloat(item.cost_platinum_sasha));
...
function calcPreferredVendor(ch,usny,sasha)
{
	var prefVendor = "CH";
	var lowest = ch;
