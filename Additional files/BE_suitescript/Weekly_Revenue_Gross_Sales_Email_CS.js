...
function Weekly_Revenue_Email()
{
	...
	try
	{
		...
		filters[1] = new nlobjSearchFilter("salesrep",null,"noneof",["@NONE@","-5","1877","3905","24207"])
	...
	try
	{
		...
		var emailBody = "";
		emailBody += "<h3>Weekly Revenue By Sales Rep<br/>Week of " + startDate + " thru " + endDate + "</h3>";
		...
		nlapiSendEmail(-5,7820,"Weekly Revenue By Sales Rep: " + startDate + " thru " + endDate,emailBody);
	}
	catch(err)
	{
