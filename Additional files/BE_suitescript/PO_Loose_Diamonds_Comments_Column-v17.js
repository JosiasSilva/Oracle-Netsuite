 ...
 * Change Log:
 *   Date            Version      Notes
 *   Jun 13 2016     14.0         Updated to include Loose Ruby (14) and Loose Emerald (20) types into script execution
 */
...
function setPOCommentsCol(type)
{
	if(type=="create" || type=="specialorder")
	{
		...
		try
		{
			...
			//or Overnight (5852231) or Choice Jewelers (4740113) or Endless Designs (2388331) or Guild and Facet (5181551)
			if(vendorID!=153 && vendorID!=7773 && vendorID!=442500 && vendorID!=1223843 && vendorID!=1587345 && vendorID!=5852231 && vendorID!=4740113 && vendorID!=2388331 && vendorID!=5181551)
				return true
