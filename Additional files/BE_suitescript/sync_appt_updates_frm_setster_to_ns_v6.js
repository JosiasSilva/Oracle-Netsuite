  ...
  try {       
    ...
    if (customerMail) {
      ...
      if(post_appt_status==11){
		...
		bodyMsg = "<p>Hi " + companyFName + "," + "</p><p>You've successfully cancelled your appointment at Brilliant Earth. If you have any questions please contact us at 800-691-0952. Thank you for taking the time to let us know you will not be able to make it and we hope to see you another time.</p><p>-Brilliant Earth Team</p>";
