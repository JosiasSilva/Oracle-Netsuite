...
function Exchange_Landing_Page(soRec,soId)
{
  ...
  */
  ...
  // fld = form.addField("custpage_rep_in_comm", "select", "Rep in Comm", "employee", "exchange").setDefaultValue(nlapiGetUser()); // Added: NS-1363 - Oct 08, 2018 - Nikhil
  
  /* Start: Added by Nikhil on December 13, 2018 for NS-1363 */
  fld = form.addField("custpage_rep_in_comm", "select", "Rep in Comm", "employee", "exchange"); // Added: NS-1363 - Oct 08, 2018 - Nikhil
