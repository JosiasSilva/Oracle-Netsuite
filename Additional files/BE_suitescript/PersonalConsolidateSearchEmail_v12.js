...
function consolidatedSearchPersonalEmail() {
  try {
    ...
    ArrSearchIdNames.push('10277#1# Wells Fargo App');
    ...
    ArrSearchIdNames.push('9957#4# Billing/CS Status - Info Needed From CS'); // Added by JJ 18-Sept-2018
	ArrSearchIdNames.push('9645#3# BE Internal Follow Up Needed'); // Added by JHaas 21-Mar-2019
    ArrSearchIdNames.push('10352#4# All leads no replied to customer within 3 weeks via email');
    ArrSearchIdNames.push('9972#8# Customer Inquiries Requiring Response');
    
   nlapiLogExecution('debug',"ArrSearchIdNames",JSON.stringify(ArrSearchIdNames));
    ...
    if (ArrLength > 0) {
      ...
      for (i = 0; i < ArrLength; i++) {
       ...
       // nlapiLogExecution('debug',"Type of IdNameArr",typeof(IdNameArr));
