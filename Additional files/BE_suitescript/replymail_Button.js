...
if(messageid){\
window.open("/app/site/hosting/scriptlet.nl?script=2217&deploy=1&msgId="+messageid+"&custpage_recid="+custpage_recordid+"&custpage_rectype="+custpage_recordtype+"&customerEmail="+email,\"Reply As CSS\",\"width=700,height=500\");\
}\
}\
';
