        ...
        else
        {
          ...
          for(var l=0; l< result.length; l++)
          {
            ...
            {						
              ...
              if(Math.abs(parseFloat(range1)- parseFloat(measurements)).toFixed(2)==0.20 || Math.abs(parseFloat(measurements)-parseFloat(range2)).toFixed(2)==0.20
                 ||
                 Math.abs(parseFloat(range3)-parseFloat(measurements)).toFixed(2)==0.10 ||  Math.abs(parseFloat(measurements)-parseFloat(range4)).toFixed(2)==0.10)
              {
                nlapiLogExecution('debug','Matched halo melee count page ID : ',result[l].getId());		
                flag = false;
                return false;
              }
            }
