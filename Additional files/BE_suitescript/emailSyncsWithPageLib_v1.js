...
// Added new parameter (other_recipient_add_to_cc) in below function according to NS-1254
function attachEmailToMesssage(fromEmail,toEmails,subject,htmlBody,attachmentsFile,leadID,textBody,other_recipient_add_to_cc)
{
  //try
  //{
  ...
  if(other_recipient_add_to_cc !='' && other_recipient_add_to_cc!=null)
    msgRecord.setFieldValue('cc',other_recipient_add_to_cc);
  ...
  /* catch(ex)
    {
      nlapiLogExecution("Debug","Error occur in creating new record for external sync",ex.message);
    }*/
  //}
  /* catch(ex)
  {
