      ...
      if(toInfo==true || toSupport==true)
      {
        ...
        if(results)
        {
            ...
            /*if(textBody!=null && textBody!="")
          {
            ...
            // attachEmailToMesssage(fromEmail,toEmails,subject,htmlBody,attachmentsFile,custId,textBody,ccEmailsNS);
        ...
        else
        {
            ...
            /* if(textBody!=null && textBody!="")
          {
           ...
           //fileAttachments(attachments,attachmentsFile);
            ...
            //attachEmailToMesssage(fromEmail,toEmails,subject,htmlBody,attachmentsFile,leadID,textBody,ccEmailsNS);
