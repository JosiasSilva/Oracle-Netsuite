		...
		try
		{
			...
			else if(type=="edit")
			{
				...
				else
				{
					...
					else if(nlapiGetOldRecord().getFieldValue("custbody6")!=record.getFieldValue("custbody6"))
					{
					...
					else if(nlapiGetOldRecord().getFieldValue("custbody_po_ship_date")!=record.getFieldValue("custbody_po_ship_date"))
					{
						...
						if(record.getFieldValue("custbody_po_ship_date")!=null && record.getFieldValue("custbody_po_ship_date")!="")
						{
							...
							nlapiSubmitField("purchaseorder",nlapiGetRecordId(),"custbody39",nlapiDateToString(dateNeededInSF,"date"));	
						}
					}
				}
			}
