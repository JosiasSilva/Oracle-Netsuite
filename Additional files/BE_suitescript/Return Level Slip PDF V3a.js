    ...
    try
    {
      ...
      if(custpage_record_id!=null && custpage_record_id!="")
      {
        ...
        if(results)
        {
          ...
          typeOfOrder = results[0].getValue("custbody87");
		...
		//var typeOfOrder = nlapiLookupField(request.getParameter("custpage_record_type"),request.getParameter("custpage_record_id"),"custbody87");
		var filters = [];
		...
		if(shipToResults)
		{
          ...
          var templateID ='26051782';// nlapiGetContext().getSetting("SCRIPT","custscript_fedex_return_xml");
          ...
          nlapiSubmitField ( 'returnauthorization' , custpage_record_id , ['custbody138','custbody137','custbody123'] , ['3',fileID,trackingNumber] ) ;
