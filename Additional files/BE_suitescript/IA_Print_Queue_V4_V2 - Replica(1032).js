...
function IA_Print_Queue(request,response)
{
  if(request.getMethod()=="GET")
  {
    ...
    fld.setDefaultValue("0");
      var exclude_orders = [];
	  var save_search_exclude_orders=['5373','5374','5375'];//['5315','5295','5296'];
	  for(var f=0;f<save_search_exclude_orders.length;f++)
	  {
		  var results = nlapiSearchRecord("salesorder",save_search_exclude_orders[f]);
		  if(results)
		  {
    ...
    var results = nlapiSearchRecord("salesorder",'5376',filters);
    if(results)
    {
