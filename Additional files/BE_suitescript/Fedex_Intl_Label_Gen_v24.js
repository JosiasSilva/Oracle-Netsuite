...
//v24 - Merges changes from v21b (label masking for drop ships) and v23 (Other information for AU orders)
...
function Gen_Fedex_Label(shipId,autoIF)
{
	...
	if(results)
	{
		...
		if(shipFromResults)
		{
			if(shipFromResults[0].getValue("custrecord_use_vendor_ship_from_address")=="T" && results[0].getValue("custbody39")!=null && results[0].getValue("custbody39")!="")
			{
				...
				{
					labelObj.ship_from_address1 = "26 O'Farrell St.";
					labelObj.ship_from_address2 = "Floor 10";
					labelObj.ship_from_city = "San Francisco";
					labelObj.ship_from_state = "CA";
					labelObj.ship_from_zipcode = "94108";
					labelObj.ship_from_country = "US";
				}
			}
			else
			{
	...
	*/
	...
	{
		var templateID = "30514621"; //FedEx International Tag API v9 - FedEx CI - PROD.xml
		var folderID = "8762529";
	}
	else
	{
		var templateID = "30211400"; //FedEx International Tag API v9 - FedEx CI - PROD.xml
		var folderID = "8762529";
	}
