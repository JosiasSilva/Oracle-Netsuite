...
function SetDiamondETA(type)
{
  try
  {
    ...
    if(type == "create" || type == "edit" || type == "xedit")
    {
      ...
      if(new_diamondStatus == 1 && old_diamondStatus == 1)//DP-478
      {
        if(diamond_Eta == '' || diamond_Eta == null)
        {
          old_diamondStatus ='';
          nlapiLogExecution("debug","Old Diamond Status in IF block:","Old Diamond Status is : " + old_diamondStatus);
        }
      }
      ...
      if(old_diamond_eta == new_diamond_eta || (old_diamond_eta == null && new_diamond_eta == ''))
      {
        ...
        {				
          ...
          //DP-471
          if( (old_diamondStatus != 1 && (new_diamondStatus == 1 || diamondStatus == 1 ) && (new_portalReqType ==3 || new_portalReqType ==4 || portalReqType == 3 || portalReqType == 4)) || (old_itemStatus != 2 && new_itemStatus == 2 && itemStatus == 2  && old_diamondStatus != new_diamondStatus && (new_portalReqType == 3 || new_portalReqType==4 || portalReqType == 3 || portalReqType == 4)))	//Changed New condition				
          {
