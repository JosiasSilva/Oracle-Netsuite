                ...
                else if(type == 'view' )
                {
                  ...
                  if(MStatus != 'T')
                  {
                    ...
                    if(MCount>0)
                    {
                      ...
                      var table='<table class="MeleeItemsCSS" style="width:600px; border: none;"><tr><td><input type="submit" class="submitMelee" value="Save" data-type="'+MeleeFlag+'" data-poId="'+poId+'" data-MainItem="'+ItemId+'"  data-melee="'+TotalQty+'" onclick="return submitMelee(this);" />|<input type="submit" class="submitClose" value="Close" onclick="return PopupMelee_Items_Show();" /></td><td data-src="" id="wait" ></td></tr><tr><td></td><td><b>Current Quantity</b></td><td><b>Quantity</b></td></tr>'+data+ html_store_melee_count+center_shape_fld+measurements_fld+'</table>';
