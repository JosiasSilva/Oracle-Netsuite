function Chk_OneRing_With_Modifications_Email_Template(order,xml,pages,today,currency,email,iaTemp,chkCategory,pageData,isIABlockCode)
{
  ...
  {
    var xml_ia_for_modified_order_email_temp = IA_For_Modified_Orders_Email_Template(order,xml,replacementAmountforModifiedOrders,descriptionforModifiedOrders,pages,today,currency,email,iaTemp,chkCategory,pageData,isIABlockCode);
    if(xml_ia_for_modified_order_email_temp !='')
      return xml_ia_for_modified_order_email_temp;
    else 
      return '';
  }
  else 
...
function IA_For_Modified_Orders_Email_Template(order,xml,replacementAmountforModifiedOrders,descriptionforModifiedOrders,pages,today,currency,email,iaTemp,chkCategory,pageData,isIABlockCode)
{
