...
function TO_Satellite_PU_Receive(type)
{
	if(type=="create")
	{
		try
		{
            ...
            nlapiLogExecution("error","PO Dropship",poDropShip);
			...
			cols.push(new nlobjSearchColumn("custbody69"));
			...
			if(results)
			{
				...
				transferOrder.setFieldValue("custbody69",results[0].getValue("custbody69"));
