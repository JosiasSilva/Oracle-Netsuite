...
function Page_Init_Fun(type) {
  ...
  nlapiDisableLineItemField('custpage_items_returning', "custpage_items_returning_item_link", true);
  nlapiDisableLineItemField('custpage_items_returning', "custpage_items_returning_created_from", true);
}
function pageRefresh()
{
  //window.location.reload(true);
}
function Post_Sale_Line_Init_Fun()
{
  highLightBackgroundColor();
  highLightBackgroundColorForNewItemOrdered();
  /*if(nlapiGetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_created_from_disable")=='T')
  {
    nlapiDisableLineItemField('custpage_items_returning', "custpage_items_returning_created_from", true);
  }else  if(nlapiGetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_created_from_disable")=='F')
  {
    nlapiDisableLineItemField('custpage_items_returning', "custpage_items_returning_created_from", false);
  }*/
  nlapiDisableLineItemField('custpage_items_returning', "custpage_items_returning_item_link", true);
  nlapiDisableLineItemField('custpage_items_returning', "custpage_items_returning_created_from", true);
}
function Post_Sale_Exchange_Fld_Changed_Fun(type,name)
{
  ...
  if(name=="custpage_orig_sales_rep")
  {
    //nlapiSetFieldValue('custpage_orig_sales_rep',nlapiGetFieldValue('custpage_orig_sales_rep'),true,true);
  }
  /*Start Populate  New Item Order(s)*/
  if(type=="custpage_new_items" && name=="custpage_new_items_center_stone_sku")
  {
  ...
  /* End Here */
  /* Start Auto Populate Description in Customer Item Shipping At BE  Sublist */ 
  //custpage_items_returning_check
  if(type=="custpage_items_returning" && name=="custpage_items_returning_created_from")
  {
    nlapiRefreshLineItems('custpage_items_returning');
  }
  if(type=="custpage_items_returning" && name=="custpage_items_returning_related_sales_order")
  {
    nlapiRefreshLineItems('custpage_items_returning');
  }
  if(type=="custpage_items_returning" && name=="custpage_items_returning_item")
  {
    nlapiRefreshLineItems('custpage_items_returning');
    /*var check_item_rtn = nlapiGetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_check");
    if(check_item_rtn==null || check_item_rtn == '')
    {
      alert('Please first select your option from list');
      nlapiSetCurrentLineItemValue("custpage_items_returning", "custpage_items_returning_item" , '') ;
      return false;
    }*/
    if(nlapiGetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_sale_amount")=='' || nlapiGetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_sale_amount")==null)
    {
      nlapiSetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_created_from_disable",'T');
    }
    var itemId =  nlapiGetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_item");
    var itemPrice =0;
    if(itemId!=null && itemId!='')
    {
      ...
      try
      {
        ...
        nlapiSetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_desc",salesdescription);
        nlapiSetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_sale_amount",nlapiFormatCurrency(itemPrice));
        nlapiSetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_item_link",parentText);
        nlapiSetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_item_type",itemType);
      }
      catch(ex)
      {
        try
      ...
      //document.getElementsByClassName("listinlinefocusedrow")[1].click();
      highLightBackgroundColor();
    }
  }
  /*          End Here            */
  if(type=="custpage_items_returning" && name=="custpage_items_returning_center_stone_sku")
  {
    nlapiRefreshLineItems('custpage_items_returning');
    //commented as per client feedback 
    /* var center_stone_link_price =0;
    var totalInsuranceValue =0;
    var itemId= nlapiGetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_center_stone_sku");
    var saleamount = nlapiGetCurrentLineItemValue("custpage_items_returning", "custpage_items_returning_sale_amount");
    if(itemId!=null && itemId!='' && saleamount !='' && saleamount != null)
    {
      try
      {
        ...
        nlapiSetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_production_ins_value",parseFloat(totalInsuranceValue));
      }
      catch(ex)
      {
        try
  ...
  /*Start Here  Auto Populate Production Insurance Value*/
  if(type=="custpage_items_returning" && name=="custpage_items_returning_sale_amount")
  {
    var saleamount = nlapiGetCurrentLineItemValue("custpage_items_returning", "custpage_items_returning_sale_amount");
    if(saleamount !='' && saleamount != null)
    {
      var totalInsuranceValue = parseFloat(saleamount)* .8 ;
      nlapiSetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_production_ins_value",parseFloat(totalInsuranceValue));
    }
  }
  /*End Here*/
  ...
  if(type=="custpage_items_returning" && name=="custpage_items_returning_check")
  {
    highLightBackgroundColor();
  }
  if(type=="custpage_items_returning" && name=="custpage_items_returning_qty")
  {
    highLightBackgroundColor();
    //document.getElementsByClassName("listinlinefocusedrow")[4].click();
  }
  if(type=="custpage_items_returning" && name=="custpage_items_returning_unit_price")
  {
    highLightBackgroundColor();
  }
  if(type=="custpage_new_items" && name=="custpage_new_items_item")
...
// On Save
function Post_Sale_Exchange_Save_Record_Fun(type,name)
{  	
  if(nlapiGetLineItemCount('custpage_new_items')==0)
  {
    var line_item_count =0;
    var curr_line_item_count =nlapiGetLineItemCount('custpage_items_returning');
    for(var licount =0; licount<curr_line_item_count;licount++)
    {
      var returnOption =  nlapiGetLineItemValue('custpage_items_returning','custpage_items_returning_check',licount+1);
      if(returnOption == '')
      {
    ...
    {
      alert('You must enter at least one line item for Item Returning to BE.');
      return false;
    }
  }
  /* START  */
  var chkReturingOption = false;
  // var chkValue =[];
  var ra =0;
  var crt =0;
  if(nlapiGetLineItemCount('custpage_new_items')==0)
  {
    for(var x=0; x < nlapiGetLineItemCount("custpage_items_returning"); x++)
    {
      var returingOption=nlapiGetLineItemValue("custpage_items_returning","custpage_items_returning_check",x+1);
      if(returingOption == '' || returingOption == null)
      {
        alert("Please select line item choose option for Item Returning to BE");
        return false;
      }
      if(returingOption != '')
      {
        if(returingOption =='5' || returingOption =='3' || returingOption =='4')
        {
          crt = parseInt(crt) + 1; 
        } 
        if(returingOption =='1' || returingOption =='2')
        {
          ra = parseInt(ra) + 1;
        }
      }
  ...
  if(parseInt(ra) >= 1 && parseInt(crt) ==0)
  {
    chkReturingOption = true;
  }
  if(chkReturingOption == true)
  {
    alert("You must enter at least one line item for Item Returning to BE.");
    return false;
  }
  ...
  for(var i=0;i<nlapiGetLineItemCount("custpage_items_returning");i++)
  {
    var returningOption = nlapiGetLineItemValue("custpage_items_returning", "custpage_items_returning_check", i+1) ;
    if(returningOption =='1'|| returningOption =='2' || returningOption =='3'|| returningOption =='4'  ||returningOption =='5')
    {
      var itemId= nlapiGetLineItemValue("custpage_items_returning","custpage_items_returning_item",i+1);
      var itemIdText= nlapiGetLineItemText("custpage_items_returning","custpage_items_returning_item",i+1);
      var  itemcat = nlapiLookupField("inventoryitem",itemId,"custitem20");
      if(nlapiGetLineItemValue("custpage_items_returning", "custpage_items_returning_amount", i+1)==""||nlapiGetLineItemValue("custpage_items_returning", "custpage_items_returning_amount", i+1) == null)
      {
        alert('Sale amount is mandatory');
        return false;
      }
      else if(nlapiGetLineItemValue("custpage_items_returning", "custpage_items_returning_unit_price", i+1)==""||nlapiGetLineItemValue("custpage_items_returning", "custpage_items_returning_unit_price", i+1) == null)
      {
        alert('Sale unit price is mandatory');
        return false;
      }
      else if(nlapiGetLineItemValue("custpage_items_returning", "custpage_items_returning_qty", i+1)==""||nlapiGetLineItemValue("custpage_items_returning", "custpage_items_returning_qty", i+1) == null)
      {
        alert('Quantity is mandatory');
        return false;
      }
      else if(nlapiGetLineItemValue("custpage_items_returning", "custpage_items_returning_production_ins_value", i+1)==""||nlapiGetLineItemValue("custpage_items_returning", "custpage_items_returning_production_ins_value", i+1) == null)
      {
        alert('Production insurance value is mandatory');
        return false;
      }
      else if(nlapiGetLineItemValue("custpage_items_returning", "custpage_items_returning_created_from_disable", i+1) == 'T')
      {
        if(itemcat !=2)
        {
          related_Sales_Order = nlapiGetLineItemValue("custpage_items_returning", "custpage_items_returning_related_sales_order", i+1);
      ...
      //if(returningOption =='1' ||returningOption =='2' ||returningOption =='3'||returningOption =='4'||returningOption =='5')
      //commented as per feedback doc 14 aug 2017
      if(returningOption =='3'||returningOption =='4'||returningOption =='5')
      {
        //var itemId= nlapiGetLineItemValue("custpage_items_returning","custpage_items_returning_item",i+1);
        //var itemIdText= nlapiGetLineItemText("custpage_items_returning","custpage_items_returning_item",i+1);
        //var  itemcat = nlapiLookupField("inventoryitem",itemId,"custitem20");
        if(itemcat == 2)
        {
          var centerStoneLink= nlapiGetLineItemValue("custpage_items_returning","custpage_items_returning_center_stone_sku",i+1);
          if(centerStoneLink == null || centerStoneLink =="")
          {
            alert('Item Returning to BE \n Center Stone SKU is mandatory for ::'+' '+ itemIdText);
            return false;
          }
        }
      }
  ...
  for(var i=0;i<nlapiGetLineItemCount("custpage_new_items");i++)
  {
    ...
    if(itemcat == 2)
    {
      var centerStoneLink= nlapiGetLineItemValue("custpage_new_items","custpage_new_items_center_stone_sku",i+1);
      if(centerStoneLink == null || centerStoneLink =="")
      {
...
function  exclude_holiday_date(result,delivery_date,weekday)
{
  ...
  //var dddate1 = new Date(delivery_date);	
  // var ddName1 = weekday[dddate1.getDay()];
  if(ddName=="Sunday" || ddName=="Saturday")
  {
...
function highLightBackgroundColor()
{
  var check_item_rtn = nlapiGetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_check");
  var itemId = nlapiGetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_item");
  var qty = nlapiGetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_qty");
  var sale_unit_price = nlapiGetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_unit_price");
  var center_stone_link = nlapiGetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_center_stone_sku");
  var related_sales_order = nlapiGetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_related_sales_order");
  var div = null;
  var created_from_disable =null;
  var itemcat =null;
  created_from_disable = nlapiGetCurrentLineItemValue("custpage_items_returning","custpage_items_returning_created_from_disable");
  if(itemId !=null && itemId !="")
  {
  ...
  if(check_item_rtn==3 || check_item_rtn==4 || check_item_rtn==5)
  {
    if(itemcat==2)
    {
      if(qty =='' || qty ==null)
        document.getElementsByClassName("listinlinefocusedrow")[1].click();
      else if(sale_unit_price =='' || sale_unit_price ==null)
        document.getElementsByClassName("listinlinefocusedrow")[4].click();
      else if(center_stone_link =='' || center_stone_link ==null)
        document.getElementsByClassName("listinlinefocusedrow")[10].click();
      div = document.getElementById('custpage_items_returning_custpage_items_returning_center_stone_sku_display');
      div.setAttribute("style", "background-color:#fce0d6 !important");
      div = document.getElementById('custpage_items_returning_custpage_items_returning_related_sales_order_display');
      div.setAttribute("style", "background-color:#white !important");

      div = document.getElementById('custpage_items_returning_qty_formattedValue');
      div.setAttribute("style", "background-color:#fce0d6 !important");

      div = document.getElementById('custpage_items_returning_unit_price_formattedValue');
      div.setAttribute("style", "background-color:#fce0d6 !important");

      div = document.getElementById('custpage_items_returning_sale_amount_formattedValue');
      div.setAttribute("style", "background-color:#fce0d6 !important");

      div = document.getElementById('custpage_items_returning_production_ins_value_formattedValue');
      div.setAttribute("style", "background-color:#fce0d6 !important");
    }
    else if(itemcat !=2)
    {
      ...
      else
      {
        ...
        else
        {
          if(qty =='' || qty ==null)
            ...
            document.getElementsByClassName("listinlinefocusedrow")[4].click();
          else if(related_sales_order=='' || related_sales_order==null)
  ...
  }else if(check_item_rtn==1 || check_item_rtn==2)
  {
    if(created_from_disable == 'F')
    {
      if(qty =='' || qty ==null)
  ...
  else if(check_item_rtn==6 || check_item_rtn=='')
  {
    div = document.getElementById('custpage_items_returning_custpage_items_returning_related_sales_order_display');
    div.setAttribute("style", "background-color:#white !important");
...
function highLightBackgroundColorForNewItemOrdered()
{
  ...
  if(itemcat==2)
  {
    ...
    div = document.getElementById('custpage_new_items_custpage_new_items_center_stone_sku_display');
    div.setAttribute("style", "background-color:#fce0d6 !important");
  }else
  {
    div = document.getElementById('custpage_new_items_custpage_new_items_center_stone_sku_display');
