  ...
  if(nlapiGetFieldValue('custpage_drop_off')=='1')
    {
	  ...
	  */
	  ...
	  /* End: Added by Nikhil on October 25, 2018 for NS-1363 */
...
function pageRefresh()
{
  ...
  //window.location.href ="https://system.sandbox.netsuite.com/app/site/hosting/scriptlet.nl?script=1890&deploy=1&compid=666639&record=6475439&backdata=false";
}
function Post_Sale_Line_Init_Fun(type)
{
  ...
  /* if(nlapiGetCurrentLineItemValue("custpage_items","sublist_created_from_disable")=='T'  || nlapiGetCurrentLineItemValue("custpage_items","sublist_created_from_disable")=='F')
  {
    nlapiDisableLineItemField('custpage_items', "sublist_created_from", true);
  }*/
  /*else
...
function Post_Sale_Repair_Fld_Changed_Fun(type,name)
{
  ...
  if(name=="custpage_country")
  {
	...
	/* Start: Added by Nikhil for NS-1363. Although this is not a part of requirement but this is causing issues */
	// nlapiSetFieldValue("custpage_status_of_international_taxes","1");
	/* End: Added by Nikhil for NS-1363. Although this is not a part of requirement but this is causing issues */
...
// On Save
function Post_Sale_Repair_Save_Record_Fun(type,name)
{
  ...
  for(var i=0;i<nlapiGetLineItemCount("custpage_items");i++)
  {
    ...
    if(sublist_shipping_to_be =='T')
    {
      ...
      var  itemcat = nlapiLookupField("inventoryitem",itemId,"custitem20");
      if(nlapiGetLineItemValue("custpage_items", "sublist_sale_amount", i+1)==""||nlapiGetLineItemValue("custpage_items", "sublist_sale_amount", i+1) == null)
      {
...
function highLightBackgroundColor()
{
  ...
  //var sale_amount = nlapiGetCurrentLineItemValue("custpage_items","sublist_sale_amount");
  var div = null;
  var  itemcat = null;
