...
function submitMeleeItem(type,name) 
{
    try 
	{
		...
		if(melee_tems_type == 'true')
		{
			...
			var TotalQty = nlapiGetFieldValue('custpage_melee_tems_qty');
			if (TotalQty != '' && TotalQty != null) 
			{
				TotalQty = parseFloat(TotalQty);
				if(TotalQty != TempTotalQty)
				{
...
function AjaxRestlet(JsonObj)
{
	...
	//var restUrl = 'https://rest.sandbox.netsuite.com/app/site/hosting/restlet.nl?script=1269&deploy=1';
