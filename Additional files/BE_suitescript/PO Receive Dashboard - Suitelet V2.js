...
Script Name :		PO Receive Dashboard - Suitelet_V2.js
Description:		Highlighting/making text Bold of a rows based on certain conditions
...
//var saved_po_search='customsearch_po_receive_dash_2' // Change by Bharath for NS-1437
  ...
  fieldValue += "callback: function(e) {";
   fieldValue +="jQuery('input[id^=inpt_custpage_dropship_new]').each(function(){";
	...
	fieldValue +="jQuery(this).parent().parent().children().each(function(){";
      // Changed Color to Yellow - Bharath BE-15
	fieldValue +="jQuery(this).style('background-color','#f2e53a','important');";
	// end code added by Bhutani NS-1240 on 27/6/18 
	fieldValue +=" });";
	fieldValue +="}";
	fieldValue +="});";

	// Addition by Bharath - NS-1437
	
    fieldValue +="jQuery('input[name^=custpage_to_be_tested_flag]').each(function(){";
	fieldValue +="var tobeTested_flag = jQuery(this).val();";
	fieldValue +="if(tobeTested_flag=='1'){";
	fieldValue +="jQuery(this).parent().parent().children().each(function(){";
	fieldValue +="jQuery(this).css('font-weight','bold');";
    fieldValue +=" });";
	fieldValue +="}";
	fieldValue +="});";

	fieldValue +="jQuery('input[name^=custpage_del_date_flag]').each(function(){";
	fieldValue +="var delDate_flag = jQuery(this).val();";
	fieldValue +="if(delDate_flag=='1'){";
	fieldValue +="jQuery(this).parent().parent().children().each(function(){";
	fieldValue +="jQuery(this).style('background-color','#f2e53a','important');";
    fieldValue +=" });";
	fieldValue +="}";
    ...
    fieldValue +="jQuery('input[name^=custpage_del_date_mon]').each(function(){";
	fieldValue +="var delDate_mon = jQuery(this).val();";
	fieldValue +="if(delDate_mon=='1'){";
	fieldValue +="jQuery(this).parent().parent().children().each(function(){";
	fieldValue +="jQuery(this).style('background-color','#f2e53a','important');";
    fieldValue +=" });";
	fieldValue +="}";
    ...
    fieldValue +="jQuery('input[name^=custpage_del_date_diff]').each(function(){";
	fieldValue +="var delDate_diff = jQuery(this).val();";
	fieldValue +="if(delDate_diff=='1'){";
	fieldValue +="jQuery(this).parent().parent().children().each(function(){";
	fieldValue +="jQuery(this).style('background-color','#f2e53a','important');";
    fieldValue +=" });";
	fieldValue +="}";
	...
	// End of Code change by Bharath - NS-1437
