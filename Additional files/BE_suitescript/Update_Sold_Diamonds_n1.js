    ...
    try
    {
      ...
      for(var x=0; x < order.getLineItemCount("item"); x++)
      {
        ...
        try
        {
          ...
          var item_obj = nlapiLookupField("item", item, ["custitem20", "custitem97", "quantityavailable", "custitemcertificate_included", "custitem198"]);
          ...
          if(item_obj.custitem20 == "7" || (item_obj.custitem20 == "18" && item_obj.custitem198 == "T"))
          {
            ...
            else
            {
              ...
              if(pla == "F")
              {
                ...
                Diamond_Portal_Logic_Rewrite(cdpId,type,recordType);
              }
              //Update item record with new price
              if(order.getFieldValue("currency") == "1")
              {
