  ...
  try {       
    ...
    if (customerMail) {
      ...
      if(apptType==2 || apptType==28){
		...
		bodyMsg = "<p>Hi " + companyFName + "," + "</p><p>Thank you for scheduling an appointment with Brilliant Earth! Your appointment is scheduled for "+dateString+" at "+apptTime+" in "+calendarloctext+".</p><p>We look forward to your visit!<br />-Brilliant Earth Team</p><p>Other Inquiries?<br /><a href=" + linkReschedule + ">Reschedule</a> this appointment<br /><a href=" + linkCancel + ">Cancel</a> this appointment<br />Please call us at 800-691-0952 with any questions.</p>";
		...
		bodyMsg = "<p>Hi " + companyFName + "," + "</p><p>Thank you for scheduling an appointment with Brilliant Earth! Your appointment is scheduled for "+dateString+" at "+apptTime+" in "+calendarloctext+". If you have not already done so, please <a href="+linkShare+">share</a> your jewelry preferences. This will enable us to provide you with the best possible experience at your upcoming appointment.</p><p>We look forward to your visit!<br />-Brilliant Earth Team</p><p>Other Inquiries?<br /><a href=" + linkReschedule + ">Reschedule</a> this appointment<br /><a href="+linkCancel+">Cancel</a> this appointment<br />Please call us at 800-691-0952 with any questions.</p>";
		/* End: Commented the bodyMsg here and added new bodyMsg field below for NS-1498 on February 14, 2019*/
      }
