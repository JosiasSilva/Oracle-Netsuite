    ...
    if (datain) {
      ...
      if (operation == 'Update') {
        ...
        if (sublist_id == 'custpage_owned_diamond' ) {
          ...
          nlapiSubmitField('inventoryitem', item_internal_id, ['custitemreason_for_diamond_return', 'custitem192', 'custitem40'], [custpage_reason_for_diamd_ret, custpage_exptd_ret_date, custpage_gemstone_status]);
          nlapiLogExecution('debug', 'Item update -', 'Successfully updated on ' + sublist_id+' for item #'+item_internal_id);
        }
