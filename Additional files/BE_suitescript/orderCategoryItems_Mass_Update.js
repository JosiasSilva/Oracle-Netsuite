/*
 * Sales Order Highest Line Item Categories
 * Type: Mass Update
 * 
 ...
 */
function setOrderCategoryItems(rec_type,rec_id)
{
	try
	{
		var filters = new Array()
		filters[0] = new nlobjSearchFilter("internalid",null,"is",rec_id)
		...
		if(results!=null)
		{
			...
			nlapiSubmitField("salesorder",rec_id,fieldID,fieldData,false)
		}	
	}
	catch(err)
	{
