		...
		for(var x=0; x < results.length; x++)
		{
			...
			if(category=="2")
			{
				...
				if(haloMeleeResult.length==0 && myParentItemId !=null && myParentItemId !='' &&  dmdStoneId!=null && dmdStoneId!='' && isHaloStyle=='T')					
				{
					...
					if(haloMeleeCollection=='6' && diamondShape=='1')							 
					 {
                    ...
                    else if(haloMeleeCollection =='6' && diamondShape!='1')								 
					 {
				...
				if(meleeSize==1 || meleeSize==2)
				{
					...
					if(searchResult.length>0)
					{
                        ...
                        if( haloMeleeId > 0 && (haloMeleeSize!='' && haloMeleeSize!=null))                
						{
							...
							var results_s = nlapiSearchRecord('item', null, null, new nlobjSearchColumn('itemid'));
							var haloItemId='';
							var haloItemName='';
