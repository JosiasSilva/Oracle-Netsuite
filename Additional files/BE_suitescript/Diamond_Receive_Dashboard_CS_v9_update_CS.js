...
function Save_Validate()
{
  ...
  for(var x=1; x <= nlapiGetLineItemCount ( 'custpage_list') ; x++)
  {
    ...
    if(nlapiGetLineItemValue('custpage_list', 'custpage_diamond_in_hold_binder', x) =="T")
    {
      ValueChk=false;
      break;
    }
  ...
  for(var x=1; x <= nlapiGetLineItemCount ( 'custpage_list') ; x++)
  {
    if(nlapiGetLineItemValue('custpage_list', 'custpage_diamond_in_hold_binder', x) =="T" && (nlapiGetLineItemValue('custpage_list', 'custpage_certificate_included', x) =="" || nlapiGetLineItemValue('custpage_list', 'custpage_certificate_included', x)==null) )
    {
