...
function process(email)
{
  try
  {
    ...
    finally
    {
      ...
      var ccEmailsCount =0;
      var toEmailCount =0;
      //Inactive CSS Reps: Results (Saved Search) [NS-892]
      var searchresult = nlapiSearchRecord(null,8015,null,null);
      ...
      nlapiLogExecution("DEBUG","To cssterm",tocss_term);
      ...
      // End Here
      // Add Cc emails in NS under communication tab (scenario two)
      ...
      nlapiLogExecution("DEBUG","Added Cc emails into Cc col in NS",ccEmailsNS);
      if(tocss_term==true)
      {
        ...
        if(results)
        {
          try
          {
            ...
            //commented old function due to new requirement NS-1254
            ...
            attachEmailToMesssage(fromEmail,primary_recipient,subject,htmlBody,attachmentsFile,custId,textBody,other_recipient_add_to_cc,ccEmailsNS);//new fun() having new parameters
        ...
        else
        {
          try
          {
            ...
            // According to NS-1254 updated old function
            attachEmailToMesssage(fromEmail,primary_recipient,subject,htmlBody,attachmentsFile,leadID,textBody,other_recipient_add_to_cc,ccEmailsNS);//new fun() having new parameters
