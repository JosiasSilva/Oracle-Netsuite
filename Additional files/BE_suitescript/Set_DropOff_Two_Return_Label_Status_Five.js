function Set_DropOff_Two_Return_Label_Status_Five(dropOff,returnLabelStatus)
{
  ...
  try
  {
    // form.addTab("custpage_set_review_tab","");
    // form.addSubTab("custpage_set_review_subtab","").setLabel('New Item Ordered');
    ...
    //nlapiLogExecution("Debug","Back Data Url for Set",backDataUrl_LandingPage);
    ...
    form.addField('custpage_set_id','text').setDisplayType('hidden').setDefaultValue('4');
    ...
    var  item_rtn_be=form.addSubList('custpage_customer_item_returning_be', 'list', '');
    ...
    for(var x=0; x < request.getLineItemCount("custpage_new_items"); x++)
    {
      ...
      new_item_ordered_arr.push({
        custpage_new_item_item : request.getLineItemValue("custpage_new_items","custpage_new_items_item",x+1),
        ...
        custpage_new_item_rate : request.getLineItemValue("custpage_new_items","custpage_new_items_rate",x+1),
        amount: request.getLineItemValue("custpage_new_items","custpage_new_items_amount",x+1),
        custpage_new_items_production_insurance_value : request.getLineItemValue("custpage_new_items","custpage_new_items_production_insurance_value",x+1),
        custpage_center_stone_sku :request.getLineItemValue("custpage_new_items","custpage_center_stone_sku",x+1),
        itemText : itemName

      });
    }
    var  new_item_ordered_be=form.addSubList('custpage_new_item_order', 'list','');
    new_item_ordered_be.addField('custpage_new_item_item','select', 'Item','item').setDisplayType('hidden');
    ...
    new_item_ordered_be.addField('custpage_new_item_rate','currency', 'Rate').setDisplayType('hidden');
    new_item_ordered_be.addField('quantity','integer', 'Quantity').setDisplayType('hidden');
    new_item_ordered_be.addField('custpage_new_items_production_insurance_value','currency', 'Production Insurance Value').setDisplayType('hidden');
    new_item_ordered_be.addField('custpage_center_stone_sku','select','Center Stone SKU','item').setDisplayType('hidden');
    new_item_ordered_be.setLineItemValues(new_item_ordered_arr);


    var return_customer_items_return_to_be_set = Customer_Items_Return_to_BE_Set(rtnItemBe);
    var return_new_item_ordered_html_set = new_Item_Ordered_Html_Set(new_item_ordered_arr);


    if(return_customer_items_return_to_be_set!='')
      form.addField('custpage_customer_item_return_to_be_html','inlinehtml').setLayoutType('outsidebelow', 'startrow').setPadding(10).setDefaultValue(return_customer_items_return_to_be_set);

    if(return_new_item_ordered_html_set !='')
      form.addField('custpage_new_item_ordered_html','inlinehtml').setLayoutType('outsidebelow', 'startrow').setPadding(1).setDefaultValue(return_new_item_ordered_html_set);
  ...
  {
    nlapiLogExecution("error","Set if block","Details: " + err.message);
    return true;
  }
}

function new_Item_Ordered_Html_Set(new_items_ordered_set)
{
  var new_Item_Html_set ='';
  if(new_items_ordered_set.length>0)
  {
    new_Item_Html_set =new_Item_Html_set + '<div style="border: 1px solid #CCCCCC !important;">';
    new_Item_Html_set =new_Item_Html_set + '<table width="100%" border="0" cellspacing="0" cellpadding="0" class="bgsubtabbar">';
    new_Item_Html_set =new_Item_Html_set + '<tbody>';
    new_Item_Html_set =new_Item_Html_set + '<tr>';
    new_Item_Html_set =new_Item_Html_set + '<td colspan="4" class="formsubtabon formsubtabtext formsubtabtexton">New Item(s) Ordered</td>';
    new_Item_Html_set =new_Item_Html_set + '</tr>';
    new_Item_Html_set =new_Item_Html_set+ '<tr class="uir-machine-headerrow">';
    new_Item_Html_set =new_Item_Html_set +'<td height="100%" class="listheadertdleft listheadertextb uir-column-large"><div class="listheader">Item</div></td>';
    new_Item_Html_set =new_Item_Html_set +'<td height="100%" class="listheadertd listheadertextb uir-column-large"><div class="listheader">Description</div></td>';
    new_Item_Html_set =new_Item_Html_set+ '<td height="100%" class="listheadertd listheadertextb uir-column-medium"><div class="listheader">Quantity</div></td>';
    new_Item_Html_set =new_Item_Html_set +'<td height="100%" class="listheadertd listheadertextbrt uir-column-x-large"><div class="listheader">Amount</div></td>';
    new_Item_Html_set =new_Item_Html_set +'</tr>';
    for(var i=0; i < new_items_ordered_set.length; i++)
    {
      new_Item_Html_set =new_Item_Html_set+ '<tr class="uir-list-row-tr uir-list-row-odd">';
      new_Item_Html_set =new_Item_Html_set +'<td class="uir-list-row-cell listtext">'+ new_items_ordered_set[i].itemText  +'</td>';
      //new_Item_Html_set =new_Item_Html_set +'<td class="uir-list-row-cell listtext"><textarea rows="2" cols="100" readonly>'+  new_items_ordered_set[i].desc +'</textarea></td>';
      new_Item_Html_set =new_Item_Html_set +'<td class="uir-list-row-cell listtext"><label>'+ new_items_ordered_set[i].desc +'</label></td>';
      new_Item_Html_set =new_Item_Html_set +'<td class="uir-list-row-cell listtext" align="center">'+ new_items_ordered_set[i].quantity +'</td>';
      new_Item_Html_set =new_Item_Html_set+ '<td class="uir-list-row-cell listtext" align="right">'+ new_items_ordered_set[i].amount +'</td>';
      new_Item_Html_set =new_Item_Html_set +'</tr>';
    }
    new_Item_Html_set =new_Item_Html_set+'</tbody>';
    new_Item_Html_set =new_Item_Html_set +'</table>';
    new_Item_Html_set =new_Item_Html_set + '</div>';
  }
  nlapiLogExecution("Debug","View [New Item Ordered SET] Html",  new_Item_Html_set);
  return  new_Item_Html_set ;
}
function Customer_Items_Return_to_BE_Set(cust_items_return_to_be_set)
{
  var customer_Item_Return_to_BE_Set ='';
  if(cust_items_return_to_be_set.length>0)
  {
    customer_Item_Return_to_BE_Set =customer_Item_Return_to_BE_Set + '<div style="border: 1px solid #CCCCCC !important;">';
    customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set +'<table width="100%" border="0" cellspacing="0" cellpadding="0" class="bgsubtabbar">';
    customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set  +'<tbody>';
    customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set + '<tr>';
    customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set  +'<td height="100%"  colspan="4" class="formsubtabon formsubtabtext formsubtabtexton">Customer Item Return to BE</td>';
    customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set  + '</tr>';
    customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set  + '<tr class="uir-machine-headerrow">';
    customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set  +'<td height="100%" class="listheadertdleft listheadertextb uir-column-large"><div class="listheader">Item</div></td>';
    customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set +'<td height="100%" class="listheadertd listheadertextb uir-column-large"><div class="listheader">Description</div></td>';
    customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set + '<td height="100%" class="listheadertd listheadertextb uir-column-medium"><div class="listheader">Quantity</div></td>';
    customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set  +'<td height="100%" class="listheadertd listheadertextbrt uir-column-x-large"><div class="listheader">Amount</div></td>';
    customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set +'</tr>';

    for(var i=0; i < cust_items_return_to_be_set.length; i++)
    {
      customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set + '<tr class="uir-list-row-tr uir-list-row-odd">';
      customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set  +'<td class="uir-list-row-cell listtext">'+ cust_items_return_to_be_set[i].itemText  +'</td>';
      // customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set  +'<td class="uir-list-row-cell listtext"> <textarea rows="2" cols="100" readonly>'+  cust_items_return_to_be_set[i].desc +'</textarea></td>';
      customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set  +'<td class="uir-list-row-cell listtext"><label>'+  cust_items_return_to_be_set[i].desc +'</label></td>';
      customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set +'<td class="uir-list-row-cell listtext" align="center">'+ cust_items_return_to_be_set[i].quantity +'</td>';
      customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set + '<td class="uir-list-row-cell listtext" align="right">'+ cust_items_return_to_be_set[i].amount +'</td>';
      customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set  +'</tr>';
    }
    customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set  +'</tbody>';
    customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set  +'</table>';
    customer_Item_Return_to_BE_Set = customer_Item_Return_to_BE_Set  + '</div>';
    nlapiLogExecution("Debug","View[Customer Item Return to BE SET] Html", customer_Item_Return_to_BE_Set);
  }
  return  customer_Item_Return_to_BE_Set;
}
