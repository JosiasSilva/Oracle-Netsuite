...
function  sendEmailWithAttachmentForResize(soid,emailTempId,fileid,ccemail,toEmail,userId,userEmail)
{
  ...
  // commented below code for send email due to new requirement 
  // nlapiSendEmail(userId, toEmail, renderSubj, renderBody , ccemail, null, rec,attachFile);
  // Added for new requirement [NS-1255] now sender will be Brilliant Earth Customer Support instead of the user 
  // employee id for Brilliant Earth Customer Support is 20561     
  nlapiSendEmail(20561, toEmail, renderSubj, renderBody , ccemail, null, rec,attachFile);
