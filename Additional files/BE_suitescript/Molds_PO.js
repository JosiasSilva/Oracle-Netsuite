function Create_Mold(type)
{
	if(type=="create" || type=="edit")
	{
		try
		{
			...
			{
				if(nlapiGetLineItemValue("item","custcol13",x+1)=="T" && (nlapiGetLineItemValue("item","custcol17",x+1)!=null && nlapiGetLineItemValue("item","custcol17",x+1)!=null) && (nlapiGetLineItemValue("item","custcol_mold_new",x+1)==null || nlapiGetLineItemValue("item","custcol_mold_new",x+1)==null))
				{
					var mold_name = nlapiGetLineItemValue("item","custcol17",x+1);
