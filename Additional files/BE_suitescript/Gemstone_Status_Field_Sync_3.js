	...
	try
	{
		if(type=="edit")
		{
			if(rectype=="salesorder")
			{
				...
				{
					nlapiSubmitField("purchaseorder",pos[x],["custbody172","custbody103","custbody6","custbody82"],[custom_gem_status,gemstone_status,delivery_date,delivery_date_firm]);
				}
			}
			else if(rectype=="purchaseorder")
			{
				...
				if(order!=null && order!="")
				{
					nlapiSubmitField("salesorder",order,["custbody172","custbody103","custbody6","custbody82"],[custom_gem_status,gemstone_status,delivery_date,delivery_date_firm]);
