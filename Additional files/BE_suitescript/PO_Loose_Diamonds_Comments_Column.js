...
function setPOCommentsCol(type)
{
	if(type=="create" || type=="specialorder")
	{
		...
		try
		{
			...
			//Check to see if PO is to GM Casting House Inc (153) or Unique New York (7773)
			if(vendorID!=153 && vendorID!=7773)
				return true
		...
		try
		{
			...
			var commentsStr = ""
			commentsStr += "- Insure Value $" + purchasePrice + "\n"
			commentsStr += "- Vendor " + vendor + "\n"
			commentsStr += "- Measurements " + measurement + "\n"
			commentsStr += "- " + purchaseDescription + "\n"
