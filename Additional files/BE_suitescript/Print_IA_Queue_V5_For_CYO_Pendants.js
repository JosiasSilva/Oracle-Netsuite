 ...
 * FILE NAME   			: Print_IA_Queue_V5_For_CYO_Pendants.js
 ...
 * File URL	Sandbox		: https://debugger.sandbox.netsuite.com/app/common/media/mediaitem.nl?uploadrectype=script&id=22328833
 * File URL	Production  :
 */

function Print_IA_Queue_V5_CYO_Pendants(order,currency,today,customer_name,print_ia_queue_v5_for_earrings_pendants)
{
  ...
  {
    return Print_IA_Queue_V5_CYO_Pendants_Arr(order,currency,today,customer_name,print_ia_queue_v5_for_earrings_pendants,tempPageData);
  }
  else 
    return tempPageData;
}
function Print_IA_Queue_V5_CYO_Pendants_Arr(order,currency,today,customer_name,print_ia_queue_v5_for_earrings_pendants,tempPageData)
{
  ...
  if(cyo_pendants_pdf_arr.length>0)
  {
    ...
    tempPageData.push(print_ia_queue_v5_for_earrings_pendants(cyo_pendants_pdf_json_obj));
  }
  return tempPageData;
}