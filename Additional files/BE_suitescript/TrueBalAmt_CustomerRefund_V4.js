		...
		if(type=="create" || type=="edit" || type=="xedit")
		{
			...
			if(recordType=="customerrefund")
			{
				...
				for(var i=1;i<=itemCount;i++)
				{
					...
					if(custDepositId!='' && custDepositId!=null)
					{
					...
					if(custDepositId=='' || custDepositId==null)
					{
						var cmObj=nlapiLoadRecord('creditmemo',depositAppId);
						var cmSoId=cmObj.getFieldValue('custbody_creditmemolinked_soid');
						if(cmSoId!='' && cmSoId!=null)
						{
							soIdArr.push(cmSoId);
						}
