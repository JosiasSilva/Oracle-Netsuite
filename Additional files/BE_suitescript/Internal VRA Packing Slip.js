function createInternalVRAPackingSlip(arrProducts,VRAId,IF_Id,trackingNo,ship_from_addr, ship_to_addr) {
  try {
    var date = getTodayDate();
    var fileName = 'vra_internal_packing_slip_'+ IF_Id + '.pdf';
   ...
   // var ship_from_addr = "26 O'Farrell St, 10th Floor\n San Francisco, CA 94108\n Phone: 415-354-4628\n Fax: 505-212-4881";
    ...
    xml += '<td width="100"></td>';
    xml += '<td align="right" width="200" style="color:#77797a; font-size:10pt;font-family: Century Gothic, sans-serif;">INTERNAL PACKING SLIP</td>';
    xml += '</tr>';
    xml += '<tr height="3%">';
    ...
    strName += '<th align="center">VENDOR<br/>NAME</th>';
    strName += '<th align="center">DESCRIPTION</th>';
    strName += '<th align="center">CERT<br/>INCLUDED</th>';
    strName += '<th align="center">CERTIFICATE #</th>';
	strName += '<th align="center">VRA PO #</th>';
	strName += '<th align="center">AMOUNT</th>';
	strName += '<th align="center">QTY</th></tr>';
    strName += '</thead>';
    ...
    for (var i = 0; i < arrProducts.length; i++) {
      var item = arrProducts[i].item;
	  var vendor = arrProducts[i].vendor; 
      var desc = arrProducts[i].desc; 
      var cert_included = arrProducts[i].cert_included; 
      var certificate_no = arrProducts[i].certificate_no; 
      var vra_po = arrProducts[i].vra_po; 
	  var amount = parseFloat(arrProducts[i].amount); 
	  var qty = arrProducts[i].qty; 

      strName += '<tr>';
      strName += '<td align="center" class="maintd" style="color:#77797a; font-size:9pt;font-family: Century Gothic, sans-serif;">' + item + '</td>';
      strName += '<td align="center" class="maintd" style="color:#77797a; font-size:9pt;font-family: Century Gothic, sans-serif;">' + vendor + '</td>';
      strName += '<td align="center" class="maintd" style="color:#77797a; font-size:9pt;font-family: Century Gothic, sans-serif;">' + desc + '</td>';
      strName += '<td align="center" class="maintd" style="color:#77797a; font-size:9pt;font-family: Century Gothic, sans-serif;">' + cert_included + '</td>';
	  ...
	  strName += '<td align="center" class="maintd" style="color:#77797a; font-size:9pt;font-family: Century Gothic, sans-serif;">' + vra_po + '</td>';
	  ...
	  strName += '<td align="center" class="maintd" style="color:#77797a; font-size:9pt;font-family: Century Gothic, sans-serif;">' + qty + '</td>';
      strName += '</tr>';
    ...
    strName += '<td align="center" style="font-size:9pt; color:#77797a; background-color: #d6d7d8; font-family: Century Gothic, sans-serif;">'+tot_qty+'</td>';
    strName += '</tr>';
    strName += '</table>';
    strName += '</body></pdf>';
    ...
    if (fileA != null && fileA != '') {
      ...
      var custbody_internal_vra_packing_slip = nlapiLookupField("itemfulfillment",IF_Id,"custbody_internal_vra_packing_slip");
	  if(custbody_internal_vra_packing_slip!=null && custbody_internal_vra_packing_slip!="")
		nlapiDeleteFile(custbody_internal_vra_packing_slip);
	...
	nlapiSubmitField('itemfulfillment', IF_Id, 'custbody_internal_vra_packing_slip', fileId);
    //end of Template A
  } catch (ex) {
