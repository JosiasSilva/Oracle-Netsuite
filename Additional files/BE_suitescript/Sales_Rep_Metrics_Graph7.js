...
function salesRepMetricsGraph(portlet, column)
{
	...
	try
	{
		...
		if(results!=null)
		{
			...
			metric_data[17]["leads"] = results[0].getValue("altname", null, "count")
			...
			for(var i = 0; i < searchCols.length; i++)
			{
				...
				{
					metric_data[17]["conversions"] = results[0].getValue(searchCols[i])
				}
			}
		}
		else
		{
			metric_data[17]["leads"] = "0"
			metric_data[17]["conversions"] = "0"
		}
		...
		if(results!=null)
		{
			...
			metric_data[16]["leads"] = results[0].getValue("altname", null, "count")
			...
			for(var i = 0; i < searchCols.length; i++)
			{
				if(searchCols[i].getLabel()=="# Conversions")
				{
					metric_data[16]["conversions"] = results[0].getValue(searchCols[i])
				}
			}
		}
		else
		{
			metric_data[16]["leads"] = "0"
			metric_data[16]["conversions"] = "0"
		}
		...
		if(results!=null)
		{
			...
			metric_data[15]["leads"] = results[0].getValue("altname", null, "count")
			...
			for(var i = 0; i < searchCols.length; i++)
			{
				if(searchCols[i].getLabel()=="# Conversions")
				{
					metric_data[15]["conversions"] = results[0].getValue(searchCols[i])
				}
			}
		}
		else
		{
			metric_data[15]["leads"] = "0"
			metric_data[15]["conversions"] = "0"
		}
		...
		if(results!=null)
		{
			...
			metric_data[14]["leads"] = results[0].getValue("altname", null, "count")
			...
			for(var i = 0; i < searchCols.length; i++)
			{
				if(searchCols[i].getLabel()=="# Conversions")
				{
					metric_data[14]["conversions"] = results[0].getValue(searchCols[i])
				}
			}
		}
		else
		{
			metric_data[14]["leads"] = "0"
			metric_data[14]["conversions"] = "0"
		}
		...
		if(results!=null)
		{
			...
			metric_data[13]["leads"] = results[0].getValue("altname", null, "count")
			...
			for(var i = 0; i < searchCols.length; i++)
			{
				if(searchCols[i].getLabel()=="# Conversions")
				{
					metric_data[13]["conversions"] = results[0].getValue(searchCols[i])
				}
			}
		}	
		else
		{
			metric_data[13]["leads"] = "0"
			metric_data[13]["conversions"] = "0"
		}
		...
		if(results!=null)
		{
			...
			metric_data[12]["leads"] = results[0].getValue("altname", null, "count")
			...
			for(var i = 0; i < searchCols.length; i++)
			{
				if(searchCols[i].getLabel()=="# Conversions")
				{
					metric_data[12]["conversions"] = results[0].getValue(searchCols[i])
				}
			}
		}
		else
		{
			metric_data[12]["leads"] = "0"
			metric_data[12]["conversions"] = "0"
		}	
		...
		//************ADDED ADDITIONAL 6 MONTHS 7-05-2011***************************
		//Past Month 13
