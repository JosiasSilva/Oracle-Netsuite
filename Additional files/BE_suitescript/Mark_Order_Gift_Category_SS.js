...
function Mark_Order_Gift_Category_SS()
{
	var orders = [];
	
	var results = nlapiSearchRecord("salesorder","customsearch4330");
	if(results)
	{
	...
	for(var x=0; x < orders.length; x++)
	{
		...
		nlapiSubmitField("salesorder",orders[x].id,orders[x].fields,data);
	}
}
