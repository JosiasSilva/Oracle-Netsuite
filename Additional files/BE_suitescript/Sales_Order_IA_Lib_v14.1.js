function Sales_Order_IA(orderId,email,type)
{
  ...
  var include_price_on_receipt = order.getFieldValue('custbody97') ;
  ...
  xml += '<pdfset>';
  //NS-1501
  if(include_price_on_receipt == 'F')
  {
    nlapiLogExecution("Debug", "Include Price on Receipt" , " Include Price on Receipt #: " + include_price_on_receipt  + " having Order Id# " + orderId);
    xml += '<pdf>\
<head>\
<link name="verdana" type="font" subtype="opentype" src="${nsfont.verdana}" src-bold="${nsfont.verdana_bold}" bytes="2"></link>\
<link name="brandon" type="font" subtype="opentype" src="https://www.brilliantearth.com/media/style/bearth/fonts/Brandon_reg.otf"></link>\
<link name="freightDispPro" type="font" subtype="opentype" src="https://www.brilliantearth.com/media/style/bearth/fonts/FreightDispPro_book.otf"></link>\
<link name="freightDispSB" type="font" subtype="opentype" src="https://www.brilliantearth.com/media/style/bearth/fonts/FreightDispPro_semibold.otf"></link>\
<link name="brandonMed" type="font" subtype="opentype" src="https://www.brilliantearth.com/media/style/bearth/fonts/Brandon_med.otf"></link>\
<link name="brandonBold" type="font" subtype="opentype" src="https://www.brilliantearth.com/media/style/bearth/fonts/Brandon_bld.otf"></link>\
<macrolist>\
<macro id="nlheader"></macro>\
<macro id="nlfooter">\
<hr background-color="#000000" width="7.0in"/>\
<table align="center" cellmargin="0" cellpadding="0" margin-top="0.15in">\
<tr>\
<td width="0.25in">&nbsp;</td>\
<td class="freightDispPro pt9">Thank you for choosing Brilliant Earth and supporting ethical origin fine jewelry! We take pride that our jewelry is produced with the highest standards of quality and excellence. However, if for any reason you are not completely satisfied, you can return or exchange any order in its original condition with the following exceptions: layaway orders, custom or modified items; items that have been altered, engraved, resized, repaired or previously exchanged. Items must be returned in original and unworn condition within 30 days from the date of shipment and require a return authorization number. Orders received after this date will not be accepted for a refund, exchange, resize or repair. Within 30 days of shipment within the US we also offer one free resizing for standard style rings. Please note that custom, modified, and engraved rings are subject to resize fees and do not qualify for our complimentary resizing. Please contact 800.691.0952 with any questions or to receive a return authorization number.</td>\
<td width="0.25in">&nbsp;</td>\
</tr>\
</table>\
</macro>\
...
.brandonGrotesque {font-family: brandon;}\
.brandonGrotesqueMed {font-family:brandonMed;}\
.brandonGrotesqueBold {font-family:brandonBold;}\
.freightDispProSB {font-family:freightDispSB;}\
.freightDispPro {font-family:freightDispPro;}\
.pt9 {font-size:9pt; line-height: 11pt;}\
.pt10 {font-size:10pt; line-height: 14pt;}\
</style></head>\
<body header="nlheader" header-height="0.95in" footer="nlfooter" footer-height="2.5in">\
<table align="center">\
<tr>\
<td align="center"><p class="brandonGrotesqueMed" text-align="center" color="#000000" align="center" padding-top="15">SALES ORDER</p></td>\
</tr>\
</table>\
<hr background-color="#000000" width="7.0in" />\
<table align="center" width="7.0in">\
<tr>\
<td style="padding-bottom: 15px;" width="2.5in" class="freightDispPro pt10">Date: ${record.trandate?string.long}</td>\
<td style="padding-bottom: 15px;" width="2.5in" class="freightDispPro pt10">Order: ${record.tranid}</td>\
<td style="padding-bottom: 15px; text-align: right;" width="2.0in" class="freightDispPro pt10" align="right">${record.custbody283}</td>\
</tr>\
<tr>\
<td width="2.5in" class="freightDispPro pt10">\
<span class="brandonGrotesque pt10">${record.billaddress@label}</span><br/>\
${record.billaddress}\
</td>\
<td width="2.5in" class="freightDispPro pt10">\
<span class="brandonGrotesque pt10">${record.shipaddress@label}</span><br/>\
${record.shipaddress}\
</td>\
<td width="2.0in" class="freightDispPro pt10">&nbsp;</td>\
</tr>\
</table>\
<hr background-color="#000000" width="7.00in" />\
<table align="center" cellmargin="0" cellpadding="0" width="7.00in" height="3.00in">\
<!-- start items -->\
<#list record.item as item>\
<#if item_index==0>\
<thead>\
<tr>\
<td align="left" width="1.75in" class="brandonGrotesque pt10">ITEM</td>\
<td align="left" width="3.25in" class="brandonGrotesque pt10">DESCRIPTION</td>\
<td align="left" width="0.40in" class="brandonGrotesque pt10">&nbsp;</td>\
<td align="right" width="0.75in" class="brandonGrotesque pt10">QUANTITY</td>\
</tr>\
<tr>\
...
<#if item.custcol_category != "Melee (Diamond)" && item.custcol_category != "Melee (Sapphire)" && item.custcol_category != "Melee (Other colored gemstone)">\
<#if !(item.description=="" && (item.item=="Resize Ring ." || item.item=="Assemble Jewelry ." || item.item=="Repair Ring ." || item.item=="Head ."))>\
<tr padding-bottom="0.1in">\
<td class="freightDispPro pt10" width="1.75in"><p align="left" text-align="left">${item.item}</p></td>\
<td align="left" class="freightDispPro pt10" width="3.25in"><p align="left" text-align="left">${item.description}</p></td>\
<td align="left" class="freightDispPro pt10" width="0.40in">&nbsp;</td>\
<td align="right" class="freightDispPro pt10" width="0.75in">${item.quantity}</td>\
</tr>\
</#if></#if>\
</#list>\
<!-- end items -->\
  ...
  if(chk_repair_resize_order_type == false)
  {
    ...
    nlapiLogExecution("Debug","Return value of SO_IA_CYO_Earrings() fun :",so_ia_cyo_earrings_xml);
    if(so_ia_cyo_earrings_xml !='')
    {
      xml += so_ia_cyo_earrings_xml;
      nlapiLogExecution("Debug","XML of SO/IA CYO Earrings :",so_ia_cyo_earrings_xml);
    }
    else
    {
      ...
      nlapiLogExecution("Debug","Return value of SO_IA_CYO_Pendants() fun",so_ia_cyo_pendants_xml);
      if(so_ia_cyo_pendants_xml !='')
      {
        xml += so_ia_cyo_pendants_xml;
        nlapiLogExecution("Debug","XML of SO/IA CYO Pendants ",so_ia_cyo_pendants_xml);
      }
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            }//end of else part of one ring with modification
          }//end of else part of more than one ring with modifications
        }//end of else part of loose diamond
      }//end of else part of cyo pendants
    }//end of else part of cyo earrings
  }//end of if part check repair and resize order type is false
  xml += "</body></pdf>";
  xml += "</pdfset>";
...
function defaultActionFunction(order,isIABlock,isIABlockCode,pages,customer_name,email,iaTemp,type,currency,today)
{
  ...
  for(var x=0; x < order.getLineItemCount("item"); x++)
  {
    ...
    else if(category=="3")
    {
      ...
      if(myParentItemId!='' && myParentItemId!=null)
