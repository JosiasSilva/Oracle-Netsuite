...
function generateVendorBill(vendor,billNumber)
{
	...
	try
	{
		...
		//UPDATE POSTING PERIOD ONLY IF YEAR MATCHES
		var orderDateObj = nlapiStringToDate(orderDate);
		var billDate = vendorBill.getFieldValue("trandate");
		var billDateObj = nlapiStringToDate(billDate);
		
		if(orderDateObj.getFullYear()==billDateObj.getFullYear())
