...
function Vendor_Box_Shipping_Label(request,response)
{
	...
	cols.push(new nlobjSearchColumn("custrecord_box_type"));
	cols.push(new nlobjSearchColumn("custrecord_box_weight"));
	...
	if(results)
	{
		...
		switch(results[0].getValue("custrecord_box_type"))
		{
			case "1": //FedEx Box
				labelObj.package_type = "FEDEX_BOX";
				break;
			case "1": //FedEx Envelope
				labelObj.package_type = "FEDEX_ENVELOPE";
				break;
			case "1": //Customer Packaging
				labelObj.package_type = "YOUR_PACKAGING";
				break;
			default:
				labelObj.package_type = "YOUR_PACKAGING";
		...
		labelObj.weight = results[0].getValue("custrecord_box_weight");
	...
	{
		var templateID = "24832790";
		var folderID = "8762529";
	}
	else
	{
		var templateID = "22270623";
		var folderID = "8762529";
	}
