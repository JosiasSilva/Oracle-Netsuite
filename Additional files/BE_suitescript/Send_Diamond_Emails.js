	...
	do{
		...
		for(var x=0; x < results.length; x++)
		{
			try
			{
				...
				var price = results[x].getValue("cost","custrecord_be_diamond_stock_number");
				...
				var description = results[x].getText("custitem5","custrecord_be_diamond_stock_number");
					description+= " " + results[x].getValue("custitem27","custrecord_be_diamond_stock_number");
				...
				if(request_status=="2" || request_status=="9")
				{
