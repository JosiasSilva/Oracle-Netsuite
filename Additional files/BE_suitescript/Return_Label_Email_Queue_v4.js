...
var FEDEX_RETURN_TAG_SANDBOX = "18934560";
...
function Return_Label_Email_Queue(request,response)
{
	if(request.getMethod()=="GET")
	{
		try
		{
			...
			filters.push(new nlobjSearchFilter("custbody138",null,"noneof",["@NONE@","3","4"])); //Return Shipping Label Status != 'Label Sent to Customer', 'No Label Needed', Empty
