			...
			if(type=="create" && rectype=="purchaseorder")
			{
				...
				if(salesorder!=null && salesorder!="")
				{
					...
					if(po_custbody39!=null && po_custbody39!="")
					{
						...
						{
							vendors.push(nlapiGetNewRecord().getFieldValue("entity"));
							soRec.setFieldValues("custbody_drop_ship_vendor",vendors);
						}
				...
				{
					//If SO value is blank, update value from PO if defined. Added 06-08-2015
					var po_custbody39 = nlapiGetNewRecord().getFieldValue("custbody39");
					if(po_custbody39!=null && po_custbody39!="")
					{
