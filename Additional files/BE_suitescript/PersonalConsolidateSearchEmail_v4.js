...
function consolidatedSearchPersonalEmail()
{
	...
	{		
	   ...
	   ArrSearchIdNames.push('5422#4# Customer Follow Up'); //created error to get EtityId of Employee directly So we get via Customer
	   ...
	   ArrSearchIdNames.push('7537#1# High value appointments to be double checked');   //Added by Aradhana 8-Mar-2018 as per NS-1126
