...
function Change_Record(type,name)
{
	...
	try
	{
		if(name=="custpage_page" || name=="custpage_month" )
		{
          ...
          if(name=="custpage_month" )
          {
			...
			window.location.href = nlapiResolveURL("SUITELET","customscript_layaway_payment_dashboard","customdeploy_layaway_payment_dashboard") + "&page=" + page +"&month=" + month ;
		}
	}
	catch(err)
	{
