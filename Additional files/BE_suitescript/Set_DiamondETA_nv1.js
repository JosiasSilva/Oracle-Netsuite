            ...
            if(vendorId != '')
            {
              ...
              if(businessDays != '')
              {
                if(deadLine != null)
                {
                  ...
                  {						
                    if(shipDays != null)
                    {
                      ...
                      if(count == 1 && (shipDaysArr[0] == 1 || shipDaysArr[0] == ''))  // N/A condition
                      {
                        ...
                        diamondETA = GetDiamondETA(day,businessDays,currentDate,shipDaysArr,Id);	
                      ...
                      else if(count >= 1 && shipDaysArr[0] != 1)
                      {
                        ...
                        diamondETA = DiamondETADate(shipDaysArr,day,businessDays,currentDate,count,hours,deadLineTimeNo,Id);
                        diamondETA = new Date(diamondETA); 
                  ...
                  nlapiLogExecution(log_type,"Step 12A having cdp id:",Id);
...
function DiamondETADate(shipDaysArr,day,businessDays,currentDate,count,hours,deadLineTimeNo,Id)
{
  var diamondETA = new Date();
    ...
    if(count == 2)
    {
      if(day == shipDaysArr[0]-1)
      {
        if(parseFloat(hours) <= parseFloat(deadLineTimeNo))
        {
          ...
          diamondETA = GetDiamondETA(newDay,businessDays,nlapiAddDays(currentDate,(shipDaysArr[0]-1)-day),shipDaysArr,Id);	
        ...
        else if(parseFloat(hours) > parseFloat(deadLineTimeNo))
        {
          ...
          diamondETA = GetDiamondETA(newDay,businessDays,nlapiAddDays(currentDate,(shipDaysArr[1]-1)-day),shipDaysArr,Id);	
      ...
      else if(shipDaysArr[0]-1 < day && day <= shipDaysArr[1]-1)
      {
        ...
        else if(parseFloat(hours) > parseFloat(deadLineTimeNo) && day == shipDaysArr[1]-1)
        {
          ...
          diamondETA = GetDiamondETA(newDay,businessDays,nlapiAddDays(currentDate,diffDay),shipDaysArr,Id);
      ...
      else if(shipDaysArr[1]-1 < day)
      {
        ...
        diamondETA = GetDiamondETA(newDay,businessDays,nlapiAddDays(currentDate,((shipDaysArr[0]-1)+7)-day),shipDaysArr,Id);	
    ...
    else if(count == 3)
    {
      ...
      else if(shipDaysArr[0]-1 < day && day <= shipDaysArr[1]-1)
      {
        ...
        else if(parseFloat(hours) > parseFloat(deadLineTimeNo) && day == shipDaysArr[1]-1)
        {
          ...
          diamondETA = GetDiamondETA(newDay,businessDays,nlapiAddDays(currentDate,(shipDaysArr[2]-1)-day),shipDaysArr,Id);	
    ...
    else if(count == 4)
    {
      ...
      else if(shipDaysArr[1]-1 < day && day <= shipDaysArr[2]-1)
      {
        ...
        else if(parseFloat(hours) > parseFloat(deadLineTimeNo) && day == shipDaysArr[2]-1)
        {
          ...
          diamondETA = GetDiamondETA(newDay,businessDays,nlapiAddDays(currentDate,(shipDaysArr[3]-1)-day),shipDaysArr,Id);
      ...
      case 1:
        ...
        {                    
          if(parseFloat(hours) <= parseFloat(deadLineTimeNo))
          {
            ...
            diamondETA = GetDiamondETA(newDay,businessDays,nlapiAddDays(currentDate,1-day),shipDaysArr,Id);
          ...
          else if(parseFloat(hours) > parseFloat(deadLineTimeNo))
          {
            ...
            diamondETA = GetDiamondETA(newDay,businessDays,nlapiAddDays(currentDate,8-day),shipDaysArr,Id);
      ...
      case 2:
        ...
        {                    
          if((parseFloat(hours) <= parseFloat(deadLineTimeNo) && day <= shipDaysArr[0]-1) || (parseFloat(hours) > parseFloat(deadLineTimeNo) && day < shipDaysArr[0]-1))
          {
            ...
            diamondETA = GetDiamondETA(newDay,businessDays,nlapiAddDays(currentDate,2-day),shipDaysArr,Id);
          ...
          else if(parseFloat(hours) > parseFloat(deadLineTimeNo) && day == shipDaysArr[0]-1)
          {
            ...
            diamondETA = GetDiamondETA(newDay,businessDays,nlapiAddDays(currentDate,9-day),shipDaysArr,Id);
      ...
      case 3:
        if(day <= (shipDaysArr[0]-1))
        {
          if((parseFloat(hours) <= parseFloat(deadLineTimeNo) && day <= shipDaysArr[0]-1) || (parseFloat(hours) > parseFloat(deadLineTimeNo) && day < shipDaysArr[0]-1))
          {
            ...
            diamondETA = GetDiamondETA(newDay,businessDays,nlapiAddDays(currentDate,3-day),shipDaysArr,Id);
          ...
          else if(parseFloat(hours) > parseFloat(deadLineTimeNo)  && day == shipDaysArr[0]-1)
          {
            ...
            diamondETA = GetDiamondETA(newDay,businessDays,nlapiAddDays(currentDate,10-day),shipDaysArr,Id);
      ...
      case 4:
        if(day <= (shipDaysArr[0]-1))
        {
          if((parseFloat(hours) <= parseFloat(deadLineTimeNo) && day <= shipDaysArr[0]-1) || (parseFloat(hours) > parseFloat(deadLineTimeNo) && day < shipDaysArr[0]-1))
          {
            ...
            diamondETA = GetDiamondETA(newDay,businessDays,nlapiAddDays(currentDate,4-day),shipDaysArr,Id);
          ...
          else if(parseFloat(hours) > parseFloat(deadLineTimeNo)  && day == shipDaysArr[0]-1)
          {
            ...
            diamondETA = GetDiamondETA(newDay,businessDays,nlapiAddDays(currentDate,11-day),shipDaysArr,Id);
      ...
      case 5:
        ...
        {				
          if((parseFloat(hours) <= parseFloat(deadLineTimeNo) && day <= shipDaysArr[0]-1) || (parseFloat(hours) > parseFloat(deadLineTimeNo) && day < shipDaysArr[0]-1))
          {
            ...
            diamondETA = GetDiamondETA(newDay,businessDays,nlapiAddDays(currentDate,5-day),shipDaysArr,Id);
          ...
          else if(parseFloat(hours) > parseFloat(deadLineTimeNo)  && day == shipDaysArr[0]-1)
          {
            ...
            diamondETA = GetDiamondETA(newDay,businessDays,nlapiAddDays(currentDate,12-day),shipDaysArr,Id);
...
function GetDiamondETA(day,businessDays,currentDate,shipDaysArr,Id)
{
