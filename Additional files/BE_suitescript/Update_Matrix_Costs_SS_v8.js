...
function updateItemPricing(itemObj,startAt,currentLine)
{
	try
	{
		...
		item.cost_18kw_pref = calcPreferredVendor(parseFloat(item.cost_18kw_ch),parseFloat(item.cost_18kw_usny),parseFloat(item.cost_18kw_sasha),parseFloat(item.cost_18kw_endless),parseFloat(item.cost_18kw_benchmark));
		item.cost_18ky_pref = calcPreferredVendor(parseFloat(item.cost_18ky_ch),parseFloat(item.cost_18ky_usny),parseFloat(item.cost_18ky_sasha),parseFloat(item.cost_18ky_endless),parseFloat(item.cost_18ky_benchmark));
		item.cost_platinum_pref = calcPreferredVendor(parseFloat(item.cost_platinum_ch),parseFloat(item.cost_platinum_usny),parseFloat(item.cost_platinum_sasha),parseFloat(item.cost_platinum_endless),parseFloat(item.cost_platinum_benchmark));
...
function calcPreferredVendor(ch,usny,sasha,endless,benchmark)
{
	var prefVendor = "CH";
	var lowest = ch;
