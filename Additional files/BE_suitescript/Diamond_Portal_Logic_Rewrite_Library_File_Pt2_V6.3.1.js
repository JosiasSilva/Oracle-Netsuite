    ...
    if (type == 'create' || type == 'edit' || type == 'xedit') 
    {
      ...
      if(cdpId)
      {
        ...
        if (check_diamond_group =='B') 
        {
          ...
          var qnty_on_hand = 0;
          var qty_in_transit = 0;
          //Check on transit quantity
          var filters = [];
          filters.push(new nlobjSearchFilter("locationquantityintransit",null,"greaterthan","0"));
          ...
          //DP-482
          //To clarify, we would like this built into the Group A/Group B logic. When checking if a diamond falls into Group A or B, 
          //if a diamond is on hand OR in transit, then it should be considered at Brilliant Earth. 
          //Currently the logic only looks to see if it is on hand but with this update 
          //we would like In transit diamonds to be eligible for the Group A/B classification.
          ...
          nlapiLogExecution("DEBUG","Quantity in Transit",qty_in_transit + " having cdp " + cdpId);
          if (check_diamond_group == 'B' && (qnty_on_hand > 0 || qty_in_transit >0))// for point b
          {
        ...
        if(override_mapping_logic=='F')
        {
          if (group == 'A' || group_a== 'T') 
          {
            ...
            // Start here for DP-503
             // logic for the 'Rules that Apply to All CDP's' section
            else if(rec_Cdp_item_status_bol_val == true)
            {
              ...
              if(new_item_status == 6)// for point 1
              {
                ...
                action_needed = "";
                nlapiLogExecution("DEBUG","Step 54 A (group A)",cdpId);
              } 
              ...
              else if(new_item_status == 8)// for point 2
              {
                ...
                nlapiLogExecution("DEBUG","Step 55 A (group A)",cdpId);
              } 
              ...
              else if(new_item_status == 3)// for point 3
              {
                ...
                action_needed = "";
                nlapiLogExecution("DEBUG","Step 56 A (group A)",cdpId);
              } 
              ...
              else if(new_item_status == 7)// for point 4
              {
                ...
                action_needed = "";
                nlapiLogExecution("DEBUG","Step 57 A (group A)",cdpId);
              }
              else 
            {
              nlapiLogExecution("DEBUG","Vendor on Portal for Diamond Group A (Part 1)",cdp_obj.getFieldValue('custrecord_on_vendor_portal') + " having cdp" + cdpId);
              if(cdp_obj.getFieldValue('custrecord_on_vendor_portal') == 'T')
              {
                nlapiLogExecution('debug', 'Do not push to portal Group A Diamonds (Part 1)');
                return;
              }
            }
            }
            ...
            else if(rec_Cdp_diamond_status_bol_val == true)
            {
              ...
              if(new_diamond_status == 5)// for point 5
              {
                ...
                item_status = 6;//'Cancelled';
                action_needed = "";
                nlapiLogExecution("DEBUG","Step 58 A (group A)",cdpId);
              }
              ...
              else if (new_diamond_status == 4)// for point 6
              {
                ...
                item_status = 3;//'Not eye clean';
                action_needed = "";
                nlapiLogExecution("DEBUG","Step 59 A (group A)",cdpId);
              }
              ...
              else if (new_diamond_status == 3)// new point as per Eric new req. on 7 sep 2018
              {
                ...
                item_status = 7;//'Not available';
                action_needed = "";
                nlapiLogExecution("DEBUG","Step 59 B (group A)",cdpId);
              }
              ...
              else if (new_diamond_status == 6)//new point as per Eric new req. on 7 sep 2018
              {
                ...
                item_status = 7;//'Not available';
                action_needed = "";
                nlapiLogExecution("DEBUG","Step 59 C (group A)",cdpId);
              }
              else 
              {
              nlapiLogExecution("DEBUG","Vendor on Portal for Diamond Group A ((Part 2))",cdp_obj.getFieldValue('custrecord_on_vendor_portal') + " having cdp" + cdpId);
              if(cdp_obj.getFieldValue('custrecord_on_vendor_portal') == 'T')
              {
                nlapiLogExecution('debug', 'Do not push to portal Group A Diamonds ((Part 2))');
                return;
              }
              }
            }
            ...
            {
              nlapiLogExecution("DEBUG","Vendor on Portal for Diamond Group A (((Part 3)))",cdp_obj.getFieldValue('custrecord_on_vendor_portal') + " having cdp" + cdpId);
              if(cdp_obj.getFieldValue('custrecord_on_vendor_portal') == 'T')
              { 
                nlapiLogExecution('debug', 'Do not push to portal Group A Diamonds (((Part 3)))');
                return;
              }
            }
          }
          ...
          else if (group == 'B' || group_b =='T') 
          {
            ...
            else if(rec_Cdp_item_status_bol_val == true)
            {
              ...
              if(new_item_status == 6)// for point 1
              {
                ...
                item_status = 6;//Cancelled
                action_needed = "";
                nlapiLogExecution("DEBUG","Step 54 A (group B)",cdpId);
              } 
              //2.WHEN new Item Status = ‘EC Unknown’ 
              else if(new_item_status == 8)// for point 2
              {
                ...
                item_status = 8;//'EC Unknown';
                action_needed = 2;//'Confirmation Needed';
                nlapiLogExecution("DEBUG","Step 55 A (group B)",cdpId);
              } 
              //3.WHEN new Item Status = ‘Not Eye-Clean’ 
              else if(new_item_status == 3)// for point 3
              {
                ...
                item_status = 3;//'Not Eye-Clean';
                action_needed = "";
                nlapiLogExecution("DEBUG","Step 56 A (group B)",cdpId);
              } 
              //4.WHEN new Item Status = ‘Not Available’ 
              else if(new_item_status == 7)// for point 4
              {
                ...
                item_status = 7;//'Not Available';
                action_needed = "";
                nlapiLogExecution("DEBUG","Step 57 A (group B)",cdpId);
              }
              else// for point 3
            {
              nlapiLogExecution("DEBUG","Vendor on Portal for Diamond Group B (Part 1)",cdp_obj.getFieldValue('custrecord_on_vendor_portal') + " having cdp" + cdpId);
              if(cdp_obj.getFieldValue('custrecord_on_vendor_portal') == 'T')
              {
                nlapiLogExecution('debug', 'Do not push to portal for Group B Diamonds (Part 1)');
                return ;
              }
            }
            }
            ...
            else if(rec_Cdp_diamond_status_bol_val == true)
            {
              ...
              if(new_diamond_status == 5)// for point 5
              {
                ...
                item_status = 6;//'Cancelled';
                action_needed = "";
                nlapiLogExecution("DEBUG","Step 58 A (group B)",cdpId);
              }
              //6.WHEN new Diamond Status = ‘Not Eye-Clean’ 
              else if (new_diamond_status == 4)// for point 6
              {
                ...
                item_status = 3;//'Not eye clean';
                action_needed = "";
                nlapiLogExecution("DEBUG","Step 59 A (group B)",cdpId);
              }
              //7.WHEN new Diamond Status = ‘Not available’ 
              else if (new_diamond_status == 3)// new point as per Eric new req. on 7 sep 2018
              {
                ...
                item_status = 7;//'Not available';
                action_needed = "";
                nlapiLogExecution("DEBUG","Step 59 B (group B)",cdpId);
              }

              //8.WHEN new Diamond Status = ‘Not Availabl(group B)e-Replacement Confirmed’ 
              else if (new_diamond_status == 6)//new point as per Eric new req. on 7 sep 2018
              {
                diamond_status = 6;//'Not Available-Replacement Confirmed';
                item_status = 7;//'Not available';
                action_needed = "";
                nlapiLogExecution("DEBUG","Step 59 C (group B)",cdpId);
              }
              else// for point 3
            {
              nlapiLogExecution("DEBUG","Vendor on Portal for Diamond Group B ((Part 2))",cdp_obj.getFieldValue('custrecord_on_vendor_portal') + " having cdp" + cdpId);
              if(cdp_obj.getFieldValue('custrecord_on_vendor_portal') == 'T')
              {
                nlapiLogExecution('debug', 'Do not push to portal for Group B Diamonds ((Part 2))');
                return ;
              }
            }
            }
            ...
            {
              nlapiLogExecution("DEBUG","Vendor on Portal for Diamond Group B (((Part 3)))",cdp_obj.getFieldValue('custrecord_on_vendor_portal') + " having cdp" + cdpId);
              if(cdp_obj.getFieldValue('custrecord_on_vendor_portal') == 'T')
              {
                nlapiLogExecution('debug', 'Do not push to portal for Group B Diamonds (((Part 3)))');
                return ;
              }
            }
          }
          ...
          else 
          {
            ...
            else if (request_type == 7) 
            {
              ...
              // DP-476 AS PER ERIC'S COMMENT
              //If it is not taking % Paid into account for the logic, why is it being prevented from changing? 
              //Users should still be able to adjust to that value regardless of the % Paid.
              //% Paid would be taken into account once the CS Status is changed to Options accepted but until 
              //then users should be able to change to On Hold Pending Customer Decision.
              if(percent_paid < 20 && cs_status == 4)
              {
                if(rec_Cdp_item_status_bol_val == true)
                {
                  ...
                  if(new_item_status == 2 && cs_status == 4) // for point 4
                  {
                    ...
                    item_status = 2;//Confirmed
                    action_needed = '';//null
                    nlapiLogExecution("DEBUG","Step 32 A",cdpId);
                  }
                }//END OF IF PART OF ITEM STATUS BOL VAL
                else if(rec_Cdp_diamond_status_bol_val == true)
                {
                  //5. WHEN % Paid < 20 AND new Diamond Status = ‘On Hold – Customer Payment Pending’ AND CS Status = ‘Options accepted by customer’
                  if(new_diamond_status == 9 && cs_status == 4) // for point 5
                  {
                    diamond_status = 9;//On Hold - Customer Payment Pending
                    portal_request_type = 2;//Hold	
                    item_status = 2;//Confirmed
                    action_needed = '';//null
                    nlapiLogExecution("DEBUG","Step 36 A",cdpId);
                  }
                }// END OF ELSE PART OF DIAMOND STATUS BOL VAL
                else
                {
                  //4.WHEN % Paid < 20 AND new Item Status = ‘Confirmed’ AND CS Status = ‘Options accepted by customer’ 
                  if(new_item_status == 2 && cs_status == 4) // for point 4
                  {
                    ...
                    item_status = 2;//Confirmed
                    action_needed = '';//null
                    nlapiLogExecution("DEBUG","Step 32 B",cdpId);
                  }
                  //5. WHEN % Paid < 20 AND new Diamond Status = ‘On Hold – Customer Payment Pending’ AND CS Status = ‘Options accepted by customer’
                  else if(new_diamond_status == 9 && cs_status == 4) // for point 5
                  {
                    ...
                    item_status = 2;//Confirmed
                    action_needed = '';//null
                    nlapiLogExecution("DEBUG","Step 36 B",cdpId);
                  }
                  else // for point 1
                  {
                    diamond_status = '';//null
                  ...
                  }// END OF INNER MOST ELSE PART OF DIAMOND STATUS AND ITEM STATUS WITH CS STATUS
                }// END OF INNER ELSE PART OF DIAMOND STATUS AND ITEM STATUS BOL VAL
              }// END IF PART OF % PAID
        ...
        // START HERE
        nlapiLogExecution("DEBUG","Temp Action Needed",temp_ac_needed + " having cdp " + cdpId);
        // check action needed for invoiced
        // Users would like to update so that if Action Needed contains Invoiced, it cannot revert back to Ready to Invoice. Can you please make that update?
        var lenOfActionNeeded = 0;
        if(temp_ac_needed != null)
        {
          temp_ac_needed = String(temp_ac_needed).split(',');
          nlapiLogExecution("DEBUG","Temp Action Needed after split",temp_ac_needed + " having cdp " + cdpId);
          lenOfActionNeeded = temp_ac_needed.length;
          nlapiLogExecution("DEBUG","Action Needed Length(5)",lenOfActionNeeded + " having cdp " + cdpId);
        }
        if(lenOfActionNeeded == 1)
        {
          var invoicedIndex = temp_ac_needed.indexOf('12');
          nlapiLogExecution("DEBUG","Invoiced Index",invoicedIndex + " having cdp " + cdpId);
          if(invoicedIndex !=-1)
          {
            action_needed = "["+ temp_ac_needed +"]";
            nlapiLogExecution("DEBUG","Step 62 C", "Action Needed Invoiced : "  + action_needed + " having cdp " + cdpId);
          }
        }
        // END HERE
