			...
			for(var x=0; x < order.getLineItemCount("item"); x++)
			{
				...
				if(item_obj.custitem20=="7")
				{
					...
					if(location=="2" && (parseFloat(available) > 0 || parseFloat(committed) > 0 || parseFloat(transit) > 0))
					{
						...
						//Set Email Status to Order on Website if vendor is Hari Krishna or Monarch or Kiran or Kapu India or Laxmi or JB
						if(vendor=="28712" || vendor=="236761" || vendor=="2325705" || vendor=="2550863" || vendor=="2551373" || vendor=="3132473")
						{
