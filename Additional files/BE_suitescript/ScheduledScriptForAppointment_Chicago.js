	...
	else
	{
	 clientphone=Optional[0];
        ...
        if(clientphone.length < 22)
		{
				...
				else if( retData[i].location_name == 'Chicago')
				{
				  location = '4';
				}
						   ...
						   // ended							
							...
							try
							{
								...
								appointmentRecord.setFieldValue('custevent_appointment_total_budget','');
								    ...
								    //Added by ajay 22Aug 2016
								    else if(retData[i].type=="Service - Pick Up") // Service - Drop Off(28), Service - Pick Up(Appt type-2)
									{
									  appointmentRecord.setFieldValue('custevent_appointment_jewelry_type',9);
								    ...
								    else if(retData[i].type=="Service - Drop Off") 
									{
									  appointmentRecord.setFieldValue('custevent_appointment_jewelry_type',9);
