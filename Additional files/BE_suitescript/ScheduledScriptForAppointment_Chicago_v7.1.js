...
function SendMailToCustomer(apptId,setsId) {
    try {       
            ...
            if (customerMail) {
				        ...
				        var linkReschedule = "https://brilliantearth.setster.com/?id=" + setsId + "&h=" + token + "&act=reschedule";
                        var linkCancel = "https://brilliantearth.setster.com/?id=" + setsId + "&h=" + token + "&act=cancel";
