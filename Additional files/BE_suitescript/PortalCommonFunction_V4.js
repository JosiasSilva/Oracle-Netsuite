function PushPOToPortal(poId)
{
	try
	{
		...
		if(poId!='' && poId!=null)
		{
		   ...
		   /******************* Start Added By Yagya 04 Sep 2017 for PP-299 *******************/
		   else
		   {
				var am = date_emailed_to_vendor.indexOf('am');
				var pm = date_emailed_to_vendor.indexOf('pm');			
				if(am == -1 && pm == -1)
				{
					date_emailed_to_vendor = formatDate(date_emailed_to_vendor);
				}
			}
		   /******************* End Added By Yagya 04 Sep 2017 for PP-299 *******************/
		   //Ended by ajay
