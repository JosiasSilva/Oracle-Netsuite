                    ...
                    try {
                       ...
                       // var SubItemHead = nlapiLookupField('item', ItemId, 'custitem9');
                        ...
                        if (get_so_measurement) {
                            ...
                            if (pegHead == 'T') {
                                create_po_so_update_cads(get_parent_item[0].getValue('vendor', 'item'), get_parent_item[0].getValue('item'), data_sales_order[m], '', '4');
                            } else {
                                create_po_so_update_cads(get_parent_item[0].getValue('vendor', 'item'), get_parent_item[0].getValue('item'), data_sales_order[m], '39', '3');
                            }
							//End
                        }
