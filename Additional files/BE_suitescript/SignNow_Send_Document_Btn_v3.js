...
function SignNow_Send_Document_SL(request,response)
{
	...
	nlapiSendEmail("20561",snRec.getFieldValue("custrecord_signnow_customer"),"Your Brilliant Earth Return Shipment - Information Needed",mergeResult.getBody(),null,null,records,attachments);
