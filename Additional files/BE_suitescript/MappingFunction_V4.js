...
{		
  nlapiLogExecution('debug','cdpRecObj',JSON.stringify(cdpRecObj));
	...
	else if((cdpRecObj.reqType == 1 && cdpRecObj.paid >= 20 && cdpRecObj.grA == 'T' && cdpRecObj.assetAcct == 189) && (diamond_type == "B" || diamond_type == "AB")) // 5 (Sold)
	{
		...
		if(cdpRecObj.actionNeeded.indexOf(12) == -1 && cdpRecObj.actionNeeded.indexOf('12') == -1)
		{
	...
	/******************************************Added by Yagya Kumar 12 Dec 17 for DP-387*******************/
	...
	else if((cdpRecObj.reqType == 1 && cdpRecObj.paid >= 20 && cdpRecObj.portalReqType == 3) && (diamond_type == "Y" || diamond_type == "AY" || diamond_type == "A" || diamond_type == "AN" ))  // Line 7 (Sold)
	{
		cdpRecObj.portalReqType = 3;
		portalReqTypeText = "Sold";
		
		cdpRecObj.itemStatus = 1;
		itemStatusText = "Not confirmed";
		cdpRecObj.new_diamond_status = "";
		if(cdpRecObj.actionNeeded.indexOf(12) == -1 && cdpRecObj.actionNeeded.indexOf('12') == -1 && cdpRecObj.actionNeeded.indexOf(11) == -1 && cdpRecObj.actionNeeded.indexOf('11') == -1)
		{
			cdpRecObj.actionNeeded = '2'; 
			actionNeededText = "Confirmation Needed";
		}
