...
function Track_Package(packageId,statusOnly)
{
	...
	for(var x=0; x < errorNodes.length; x++)
	{
		...
		//Check if label was created less than 24 hours ago
		/*
		var lessThan24Hours = false;
		var labelDateCreated = nlapiLookupField("customrecord_custom_package_record",packageId,"created");
		labelDateCreated = nlapiStringToDate(labelDateCreated);
		
		var HOURS24 = 60 * 60 * 1000 * 24;
		
		if((now  - labelDateCreated) <= HOURS24)
			lessThan24Hours = true;
			
		nlapiLogExecution("debug","Less Than 24 Hours?",(now  - labelDateCreated));
		*/
	...
	if(statusOnly==false)
	{
		...
		var dateTimeNodes = nlapiSelectNodes(xmlBody,"//SOAP-ENV:Envelope/SOAP-ENV:Body/*[name()='TrackReply']/*[name()='CompletedTrackDetails']/*[name()='TrackDetails']/*[name()='DatesOrTimes']");
	...
	else
	{
		...
		var dateTimeNotes = nlapiSelectNodes(xmlBody,"//SOAP-ENV:Envelope/SOAP-ENV:Body/*[name()='TrackReply']/*[name()='CompletedTrackDetails']/*[name()='TrackDetails']/*[name()='DatesOrTimes']");
