          ...
          {		
            ...
            if(sublist_type=='1')
            {
              ...
              if(get_max_insurence>=get_insu)			
              {
                ...
                {
                 // alert('po id :- >'+ get_po_id +'  amount_compair  '+amount_compair +' max:- ' +get_max_insurence + '  ins:-  '+get_insu);
                }
            ...
            if(insu_value_temp<=amount_compair)
            {
              if(get_line_item[b].sublist_type=='1' && index_obj>=0)
              {
                if(nlapiGetUser ( ) =='13905298')
                {
                 // alert('before po id :- >'+ get_po_id +'   amount  '+insurence_amount[index_obj]);
                }
                insurence_amount[index_obj]-=get_insu;
                if(nlapiGetUser ( ) =='13905298')
                {
                 // alert('after po id :- >'+ get_po_id +'   amount  '+insurence_amount[index_obj]);
                }
              }
