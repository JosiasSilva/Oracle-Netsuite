function Gen_Fedex_Label(shipId,autoIF)
{
	...
	if(results)
	{
		...
		if(results[0].getValue("custbody87")=="1" || results[0].getValue("custbody87")=="20")
			isNewOrder = true;
		...
		if(results[0].getValue("custbody87")=="1" || results[0].getValue("custbody87")=="20") //Type Of Order = New Order
