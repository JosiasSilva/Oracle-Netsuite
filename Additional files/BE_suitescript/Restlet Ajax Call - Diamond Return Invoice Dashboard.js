...
function createTemplateA(arrProducts, invoice_id, ship_to_addr, vendor_name, vendor_special_instructions) {
  try {
    ...
    if(vendor_name=='JB')
	{
      //var search=nlapiSearchRecord('vendorbill',null,[new nlobjSearchFilter('entity',null,'anyof',3132473),new nlobjSearchFilter('item',null,'anyof',6449663)],[new nlobjSearchColumn('trandate').setSort(true),new nlobjSearchColumn('tranid')]);
