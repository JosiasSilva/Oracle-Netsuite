...
function Vendor_Box_Shipping_Label(request,response)
{
	...
	if(results)
	{
		...
		var shipService;
		nlapiLogExecution("debug","Box Shipping Method",results[0].getValue("custrecord_box_shipping_method"));
		...
		switch(results[0].getValue("custrecord_box_shipping_method"))
		{
			...
			case "5668898":
			case 5668898:
				nlapiLogExecution("debug","Using Express Saver Service");
		...
		nlapiLogExecution("debug","labelObj.service_type",labelObj.service_type);
