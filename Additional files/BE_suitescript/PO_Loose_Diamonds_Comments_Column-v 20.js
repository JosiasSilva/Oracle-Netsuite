...
function setPOCommentsCol_call(type,purchase_order,get_result)
{
 // if(type=="create" || type=="specialorder")
  //{
    ...
    if(vendorID!=153 && vendorID!=7773 && vendorID!=442500 && vendorID!=1223843 && vendorID!=1587345 && vendorID!=5852231 && vendorID!=4740113 && vendorID!=2388331 && vendorID!=5181551 && vendorID!=11081056)
      return false
      try
      {
...
function Add_Comment(poRec,itemID)
{
  ...
  var search_record=nlapiSearchRecord(null,8402,new nlobjSearchFilter('applyingtransaction',null,'anyof', poRec));
  if(search_record)
  {
    ...
    else if (ItemLink_id) 
    {
      ...
      else
      {
        ...
        {  
          var search_record_item=search_record[0].getValue("formulanumeric");
          if(search_record_item>0)
          {                  
            flag = true;
          }
        }
