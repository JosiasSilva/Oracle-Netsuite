...
{
	if(type=="custpage_list" && (name=="custpage_date_sent_from_sf" || name=="custpage_status" || name=="custpage_notes" || name=="custpage_gem_notif"))
	{
...
function VBD_PI()
{
	...
	//Added by ajay 03jan 2016
    /*jQuery('td[class^="uir-list-row-cell listtext"]').each(function(){
   ...
   //Ended by ajay 03jan 2017
  
   //Added by  Sandeep
      jQuery('input[name^="custpage_so_status"]').each(function(){
