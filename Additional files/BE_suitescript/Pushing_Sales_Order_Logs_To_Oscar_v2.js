...
function Push_Order_ID_First_Error_Message(status_code,order_id,display_error_message,celigo_id)
{
  try
  {
    ...
    headers['Authorization'] 	= 'NLAuth nlauth_account=666639, nlauth_email=nsconsultant@brilliantearth.com, nlauth_signature=7sGA2n4hd8Ci3LuyWMzLuBwjM, nlauth_role=3';
...
function Search_Success_Sync_Id(celigo_id)
{
  ...
  try
  {
    //var mySearch = nlapiLoadSearch(null, 8494); // For Sandbox
