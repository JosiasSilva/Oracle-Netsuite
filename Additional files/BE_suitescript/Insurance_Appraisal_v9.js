function Insurance_Appraisal(request,response)
{
	try
	{
		...
		{
			xml += "<p>Instruction!<br/>IA From allowed for following item:";			
			xml += "<br/>Setting with large center stone(2)";
			xml += "<br/>Ring with no large center stone(3)";
			xml += "<br/>Melee [Other colored gemstone](24)";	
            xml += "</p>";	
			xml += "</body></pdf>";
			var file = nlapiXMLToPDF(xml);
			response.setContentType("PDF","Insurance_Appraisal.pdf","inline");
