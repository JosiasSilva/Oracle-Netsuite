/*
 * CONTAINS NEW SHIPPING INSURANCE LOGIC
 */
...
{	
	...
	if(results)
	{
		...
		scilFilters.push(new nlobjSearchFilter("custrecord_shipping_method",null,"anyof",shipService));
		var scilCols = [];
		...
		if(scilResults)
		{
			...
			else
			{
				...
				else
				{
					...
					{
						insurance_label = "RE2014" + parseInt(totalCost / 0.8 - fedexLimit) + "200305";
					}
					else
					{
