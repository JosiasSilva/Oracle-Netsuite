...
function Get_Body_two(line_item,from_location_text,to_location_text)
{
  ...
  for(var a=0;a<line_item.length;a++)
  {
    ...
    var get_memo=decodeURIComponent(line_item[a].memo);
    if(get_memo)
    {
      get_memo=get_memo.replaceAll('&','&#38;');
    }
    if(a==0)
    {
      xml += '<tr style="font-size: 14px;color:#555859;font-style: normal;font-family: CenturyGothic, AppleGothic, sans-serif;font-variant: normal;line-height: 20px;">';
      ...
      xml += '<td align="center" style="border-right: 1px solid #959799;border-top: 1px solid #959799;border-bottom: 1px solid #959799;">'+get_memo+'</td>';
    ...
    else
    {
      ...
      xml += '<td align="center" style="border-right: 1px solid #959799;border-bottom: 1px solid #959799;">'+get_memo+'</td>';
