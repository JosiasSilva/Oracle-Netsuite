					...
					if(clientphone.length < 22)
					{
						...
						{ 
							...
							else
							{
									...
									Create_Appointment(leadId,obj_data)
...
function Create_Appointment(leadId,obj_data)
 {				
		...
		var apptTitle=Lead_data['altname'] + "-" + retData_type;
			try
			{
				...
				appointmentRecord.setFieldValue('custevent_appointment_total_budget','');
					...
					var custevent_appt_taken_by='1007557';
					appointmentRecord.setFieldValue('custevent_appt_taken_by',custevent_appt_taken_by);
					...
					var update_obj_data={
										...
										type:retData_type,
										custevent_appt_taken_by:custevent_appt_taken_by                               
									    }
