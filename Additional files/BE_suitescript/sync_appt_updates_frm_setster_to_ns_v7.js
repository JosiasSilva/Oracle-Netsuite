  ...
  try {       
    ...
    if (customerMail) {
      ...
      if(post_appt_status==11){
        ...
        //Start : Added : 02/25/19 : as per NS 1553 
		...
		var customerobj = nlapiLoadRecord('customer', companyId);
		...
		bodyMsg = renderBody;
		subLine = 'Your Appointment Has Been Cancelled';
		//End : Added : 02/25/19 : as per NS 1553
	  }
      else{
		/* Start: Commented the bodyMsg here and added new bodyMsg field below for NS-1498 on February 14, 2019*/
		...
		/* End: Commented the bodyMsg here and added new bodyMsg field below for NS-1498 on February 14, 2019*/
		subLine = 'Your Brilliant Earth Appointment Request'; //NS 1553
      }
      ...
      nlapiSendEmail(20561, customerMail, subLine, bodyMsg,null,"eito@brilliantearth.com", customerObject ,null,true); //NS 1553
    }
