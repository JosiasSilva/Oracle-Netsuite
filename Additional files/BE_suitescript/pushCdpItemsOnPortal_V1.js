				...
				{   
					...
					if(onVendorPortal=='F' || onVendorPortal=='T')  
					{
							...
							if(soStatus != null && soStatus != "" && soStatus == "fullyBilled")
							{
								if(old_diamond_status == new_diamond_status)
								{
									if(old_PortalReqType == 2 && new_PortalReqType == 3)
									{
										...
										nlapiLogExecution("debug","changes item status for line 6 is :","Not confirmed");
										nlapiLogExecution("debug","changes portal request type for line 6 is :","Sold");
						...
						{										 
							...
							if(old_PortalReqType == 2 && new_PortalReqType == 3 && item_status == 1)
							{
...
function GetPortalRequestVal(arr,diamond,paymentTerms,portalReqType,reqType,paid,grA,grB,itemStatus,actionNeeded,csStatus,assetAcct)
	{		
		...
		else if(reqType == 1 && paid >= 20 && grA == 'T' && assetAcct == 189) // 5 (Sold)
		{			
		...
		else if(reqType == 1 && paid >= 20 && grB == 'T' && assetAcct == 189) // 6 (Sold)
		{			
			if(diamond.indexOf("B") != -1 || diamond.indexOf("AB") != -1)
			{
				portalReqType = 3;
		...
		else if(reqType == 1 && paid >= 20) // 7 (Sold)
		{			
		...
		else if(reqType == 7 && paid >= 20 && csStatus != 4) // 9 (Replacement(diamond unavailable))
		{			
		...
		else if(reqType == 7 && paid >= 20 && csStatus == 4) // 10 (Replacement(diamond unavailable))
		{
		...
		else if(reqType == 7 && paid >= 20 && csStatus == 4 && grA == 'T' && assetAcct == 189) // 11 (Replacement(diamond unavailable))
		{						
			if(diamond.indexOf("B") != -1 || diamond.indexOf("AB") != -1)
			{
				portalReqType = 3;
		...
		else if(reqType == 7 && paid >= 20 && csStatus == 4 && grB == 'T' && assetAcct == 189) // 12 (Replacement(diamond unavailable))
		{						
			if(diamond.indexOf("B") != -1 || diamond.indexOf("AB") != -1)
			{
				portalReqType = 3;
		...
		else if(reqType == 7 && paid < 20 && csStatus != 4) // 13 (Replacement(diamond unavailable))
		{			
			if(diamond.indexOf("Y") != -1 || diamond.indexOf("AY") != -1 || diamond.indexOf("A") != -1)
			{
				portalReqType = 2;
		...
		else if(reqType == 8 && paid >= 20 && grA == 'T' && assetAcct == 189) // 14 (Replacement(Customer Switch))
		{			
			if(diamond.indexOf("B") != -1 || diamond.indexOf("AB") != -1)
			{
				portalReqType = 3;
		...
		else if(reqType == 8 && paid >= 20 && grB == 'T' && assetAcct == 189) // 15 (Replacement(Customer Switch))
		{			
			if(diamond.indexOf("B") != -1 || diamond.indexOf("AB") != -1)
			{
				portalReqType = 3;
		...
		else if(reqType == 8) // 16 (Replacement(Customer Switch))
		{			
			if(diamond.indexOf("Y") != -1 || diamond.indexOf("AY") != -1 || diamond.indexOf("A") != -1 || diamond.indexOf("A Pre-Pay") != -1 || diamond.indexOf("AN") != -1)
			{
				portalReqType = 3;
		...
		else if(reqType == 2) // 18(Appointment Request)
		{			
			if(diamond.indexOf("Y") != -1 || diamond.indexOf("AY") != -1 || diamond.indexOf("B") != -1 || diamond.indexOf("AB") != -1)
			{
				portalReqType = 4;
		...
		else if(reqType == 5 ) // 19 (Check Availability/Eye-Clean)
		{			
			if(diamond.indexOf("Y") != -1 || diamond.indexOf("AY") != -1 || diamond.indexOf("A") != -1 || diamond.indexOf("A Pre-Pay") != -1 || diamond.indexOf("AN") != -1)
			{
				portalReqType = 5;
		...
		else if(reqType == 4 ) // 20 (Photography Request)
		{			
			if(diamond.indexOf("Y") != -1 || diamond.indexOf("AY") != -1 || diamond.indexOf("A") != -1 || diamond.indexOf("A Pre-Pay") != -1 || diamond.indexOf("AN") != -1)
			{
				portalReqType = 6;
		...
		else if(reqType == 3 ) // 21 (Cert Request)
		{			
			if(diamond.indexOf("Y") != -1 || diamond.indexOf("AY") != -1 || diamond.indexOf("A") != -1 || diamond.indexOf("A Pre-Pay") != -1 || diamond.indexOf("AN") != -1)
			{
				portalReqType = 7;
