...
{    
  try
  {
    ...
    {                               
      ...
      /*******************************	Start Added by Yagya Kumar 13 Nov 2017 for PP-302**********************************/
      var so_no = '';
      var so_id = nlapiLookupField('purchaseorder',poId,'createdfrom');
      if(so_id)
      {
        so_no = nlapiLookupField('salesorder',so_id,'tranid');
        if(!so_no)
        {
          so_no = '';
        }
      ...
      /*******************************	End Added by Yagya Kumar 13 Nov 2017 for PP-302**********************************/
      var objJSON = 
          {
            "po_id" : poId,
            "portal_status":PortalStatus, 
            "transaction_id" :transid,
            "tranid":	so_no, // Added by Yagya Kumar 13 Nov 2017 for PP-302
            "so_id" :	so_id, // Added by Yagya Kumar 13 Nov 2017 for PP-302
            "items" :IteArray,
    ...
    var url = "https://testportal.brilliantearth.com/api/production/revised-po/";    
    ...
    {							
      ...
      {				   
        ...
        if(approvedToGrow != null && approvedToGrow != "")
        {
          ...
          nlapiSubmitField('purchaseorder',poId,['custbody_portal_status','custbody_pushrevisedpo','custbody_po_portal_url','custbody369'],[portalStatus,'T',poUrl,'934']);
        }
        else
        {
