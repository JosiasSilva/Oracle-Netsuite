...
function Insurance_Appraisal(request,response)
{
  try
  {
    ...
    nlapiLogExecution("Debug","Exchange Order Type (1)",chkExchangeOrderType);
    ...
    /* if(chkExchangeOrderType == true && chkRingForExchange == false)
    {
      ...
      chk_ia = IA_Exchange(order,xml,pages,today,customer_name,currency,email,iaTemp,isIABlock,isIABlockCode,iaBlockMsg,countgemStoneArr,chkCategory);
    }*/
