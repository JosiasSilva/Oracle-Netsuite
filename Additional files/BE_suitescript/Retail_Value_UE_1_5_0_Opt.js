...
function Retail_Value_UE(type)
{
	if(type=="create" || type=="edit")
	{
		try
		{
			...
			if(type=="edit" && order.getFieldValue("custbody_full_insurance_amount")!=nlapiGetOldRecord().getFieldValue("custbody_full_insurance_amount") && nlapiGetContext().getExecutionContext()=="userinterface")
			{
			...
			else if(type=="edit" && order.getFieldValue("total")==nlapiGetOldRecord().getFieldValue("total") && nlapiGetContext().getExecutionContext()=="userinterface")
			{
				...
				{
					if(order.getLineItemText("item","item",x+1).substring(0,7)=="DNU BE1" || order.getLineItemText("item","item",x+1).substring(0,7)=="DNU BE5" || order.getLineItemText("item","item",x+1).substring(0,3)=="BE1" || order.getLineItemText("item","item",x+1).substring(0,3)=="BE5" || order.getLineItemValue("item","item",x+1)=="14375" || order.getLineItemValue("item","item",x+1)=="487939" || order.getLineItemValue("item","item",x+1)=="487937" || order.getLineItemValue("item","item",x+1)=="487942" || order.getLineItemValue("item","item",x+1)=="502780" || order.getLineItemValue("item","item",x+1)=="537603" || order.getLineItemValue("item","item",x+1)=="487938" || order.getLineItemValue("item","item",x+1)=="487941" || order.getLineItemValue("item","item",x+1)=="487940")
					{
						hasRing = true;
						break;
					}
			...
			if(order_type!=RESIZE && order_type!=REPAIR && order_type!=WEDDING_BAND && order_type!=ENGRAVING && order_type!=EXCHANGE)
			{
				...
				for(var x=0; x < order.getLineItemCount("item"); x++)
				{
					...
					{	
						...
						if(order.getLineItemValue("item","amount",x+1)==0 && (category=="4" || category=="5" || category=="9" || category=="34"))
						{
						...
						else if(order.getLineItemText("item","item",x+1).substring(0,7)=="DNU BE1" || order.getLineItemText("item","item",x+1).substring(0,7)=="DNU BE5" || order.getLineItemText("item","item",x+1).substring(0,3)=="BE1" || order.getLineItemText("item","item",x+1).substring(0,3)=="BE5" || order.getLineItemValue("item","item",x+1)=="14375" || order.getLineItemValue("item","item",x+1)=="487939" || order.getLineItemValue("item","item",x+1)=="487937" || order.getLineItemValue("item","item",x+1)=="487942" || order.getLineItemValue("item","item",x+1)=="502780" || order.getLineItemValue("item","item",x+1)=="537603" || order.getLineItemValue("item","item",x+1)=="487938" || order.getLineItemValue("item","item",x+1)=="487941" || order.getLineItemValue("item","item",x+1)=="487940")
						{
							var subAmount = 0.00;
						...
						else if(order.getLineItemText("item","item",x+1).substring(0,7)=="DNU BE2" || order.getLineItemText("item","item",x+1).substring(0,3)=="BE2" || order.getLineItemValue("item","item",x+1)=="14385")
						{
