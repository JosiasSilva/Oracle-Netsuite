function All_packages_List(form,obj_get_result,number_of_result)
{
  ...
  //Bulk Recieve Drop off - NS-1344
  Sublist_all_package.addButton("custpage_bulk_recive_drop_off", "Bulk Receive Drop Off","window.open('/app/site/hosting/scriptlet.nl?script=1169&deploy=1&open_popup_drop_off=T','Bulk Receive Drop Off','height=500,width=500,left=10,top=10,titlebar=no,toolbar=no,menubar=no,location=no,directories=no,status=no')");
