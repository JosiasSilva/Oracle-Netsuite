function Gen_Fedex_Label(shipId,autoIF)
{
	...
	else if(insuranceType=="1")
	{
		...
		if((label_insurance / 0.80) > 25000)
		{
			nlapiLogExecution("debug","Using RE2014 label","Subtotal: " + (label_insurance / 0.80) + " - 25000");
			
			labelObj.customer_reference = "RE2014" + parseInt((label_insurance / 0.80) - 25000) + "200305";
			fullInsuranceAmount = 25000;
		}
		else
		{
	...
	{
		var templateID = "22408911"; //FedEx International Tag API v8 - FedEx CI - PROD.xml
		var folderID = "8762529";
	}
