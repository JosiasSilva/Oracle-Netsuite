...
nlapiLogExecution('audit','trackObj', trackObj.trackingnumber);	
...
function Update_Packages()
{
    ...
    //filters.push(new nlobjSearchFilter("custrecord_tracking_id",null,"noneof","@NONE@"));
	//filters.push(new nlobjSearchFilter("internalid",null,"is","29634"));
...
nlapiLogExecution('audit','results[x].getId()',results[x].getId());			}
			catch(err)
			{
