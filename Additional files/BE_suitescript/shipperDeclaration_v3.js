 ...
 * PB URL-1: https://system.netsuite.com/app/common/scripting/script.nl?id=1026
 * PB URL-2: https://system.netsuite.com/app/common/scripting/script.nl?id=1027
*/
...
function pdfView(lines,request,response,orderId)
{
 ...
 ///End Adds
   ...
   itemArr1.sort(function(a, b) {
	...
	htmlHeader.setDefaultValue("<script>window.opener.location.reload();</script><object width='650' height='380' data='"+PDFurl+"'></object>"); 
