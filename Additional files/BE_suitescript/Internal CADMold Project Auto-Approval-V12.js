                ...
                for (var m = 0; m < data_sales_order.length; m++) {
                    try {
                        ...
                        if (get_so_measurement) {
                            if (pegHead == 'T') {
                                create_po_so_update_cads(get_vendor_line, get_parent_item[0].getValue('item'), data_sales_order[m], '', '4');
                                continue;
                            }
                            //Molds comparison
                            ...
                            create_po_so_update_cads(get_vendor_line, get_parent_item[0].getValue('item'), data_sales_order[m], '39', '3');
                            //End
                        }
