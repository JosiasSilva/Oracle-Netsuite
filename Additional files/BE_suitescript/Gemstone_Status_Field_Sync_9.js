					...
					if(results)
					{
						for(var x=0; x < results.length; x++)
						{
							...
							if(isGemPO && location=="2")
							{
								...
								{
									if(ddChanged)
										nlapiSubmitField("purchaseorder",results[x].getValue("purchaseorder",null,"group"),["custbody103","custbody6","custbody82","custbody58"],[gemstone_status,delivery_date,delivery_date_firm,so_important_notes]);
									else
										nlapiSubmitField("purchaseorder",results[x].getValue("purchaseorder",null,"group"),["custbody103","custbody82","custbody58"],[gemstone_status,delivery_date_firm,so_important_notes]);
								}
							}
							else
							{
