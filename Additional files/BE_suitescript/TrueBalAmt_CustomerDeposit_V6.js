 ...
 * SB URL-1: /app/common/scripting/script.nl?id=823
 * SB URL-2: /app/common/scripting/script.nl?id=834
 * SB URL-3:  /app/common/scripting/script.nl?id=852
 * PB URL-1:  /app/common/scripting/script.nl?id=851&whence=
 * PB URL-2:  /app/common/scripting/script.nl?id=853&whence=
* PB URL-2:  /app/common/scripting/script.nl?id=854&whence=
*/
function cdpTrueBalAmtUpd(type)
{
        ...
        if(type=="create"  || type=="edit" || type=="xedit")  
	{
         ...
         var cdId=nlapiGetRecordId();  
	     var cdObj=nlapiLoadRecord("customerdeposit",cdId); 
         var soId=cdObj.getFieldValue('salesorder');
         var payment=cdObj.getFieldValue('payment');
         var tranid=cdObj.getFieldValue('tranid');
    ...
    if( type=="create"  || type=="edit" || type=="xedit")  
	{
		...
		try{
				   ...
				   //Added by Shiv per Rachel's feedback on Jira NS-338		
					var cmlCount=salesObj.getLineItemCount('recmachcustrecord_credit_memo_link_parent'); //Added as per NS-338
					...
					var trueNetAmt= 0;		   
					trueNetAmt= (parseFloat(totalAmount) - discAmount + parseFloat(totalTaxAmt) + parseFloat(totalShipCost) ) ;    
                    ...
                    var tb_refunds= trueObj.refunds; var MyAccount_Status=salesObj.getFieldValue("status");
					  var MyAccount_OrderType=salesObj.getFieldValue("custbody87");
					...
					{   
						...
						//nlapiSubmitField("salesorder",soId,["custbody_truebalanceamount","custbody_truebalanceadjustment","custbody_website_truebalance_amt","custbody_my_account_info_on_web"], [currencySymbol+" "+numberWithCommas(trueBalanceAmt),TrueBalAdjustAmount,trueBalanceAmt,MyAccount_WebInfo]);
