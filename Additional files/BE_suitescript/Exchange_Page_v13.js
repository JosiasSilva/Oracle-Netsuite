	...
	else
	{
		...
		try
		{
			...
			if(updateAddress)
			{
				...
				shipaddress += ra.getFieldValue("shipcountry");
		...
		try
		{
			...
			if(updateAddress)
			{
				...
				newOrder.setFieldValue("shipcountry",country);
			...
			var delta = parseFloat(new_total) - parseFloat(return_total);
			...
			{
				//If delta is negative, credit original sales rep
				newOrder.setFieldValue("salesrep",original_salesrep);
			}
