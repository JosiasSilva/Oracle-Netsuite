...
{
  var result_outgoing_load = nlapiLoadSearch(null, outgoing_to_dashboard);
  var get_filter=result_outgoing_load.getFilters();
  for(var a=0;a<get_filter.length;a++)
  {
    filter_outgoing.push(get_filter[a]);
  }
  result_outgoing_load.addFilters(filter_outgoing);
  var resultset_result_outgoing = result_outgoing_load.runSearch();
  var result_outgoing =null;
  if(data_load)
  {
    result_outgoing=resultset_result_outgoing.getResults(page_index_min, page_index_max);
  }
