			...
			{                           
			   ...
			   if(onVendorPortal=='T')
			   {
				...
				{   
					...
					{
						pushCDPtoPortal(cdpId,resultArr,portalRequestTypeId,item_status,action_needed,mapping_logic,cdpObj,onVendorPortal,requestType,paid,groupB,assetAcct,diamond,soStatus,old_diamond_status,new_diamond_status,old_PortalReqType,new_PortalReqType,old_ItemStatus,vendorId,vendorPortal,manual_override,paymentTerms,new_ItemStatus,cs_status,old_CsStatus,new_CsStatus)
					}
					else
					{
