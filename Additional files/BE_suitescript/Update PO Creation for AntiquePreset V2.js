        ...
        try {
            ...
            for (var i = 1; i <= itemCount; i++) {
                ...
                if (invItemId == '1093360' || invItemId == '1087131') {
					...
					column.push(new nlobjSearchColumn('price'));
                    ...
                    if (results != null) {
						...
						var price = results[0].getValue(col[2]);
						var productionInsuranceValue=(price*(.80));
                        categoryArr.push({
                            CategoryId: CategoryId,
                            description: description,
                            soLineDesc: soLineDesc,
							productionInsuranceValue:productionInsuranceValue
                        });
                    }
                }
            ...
            if (repResArr.length > 0) {
                ...
                for (var k = 0; k < polineCount; k++) {
                    ...
                    if (categoryArr) {
						...
						var InsuranceValue=categoryArr[0].productionInsuranceValue;
						...
						POObj.setLineItemValue("item", "custcol_full_insurance_value", k + 1, InsuranceValue);
