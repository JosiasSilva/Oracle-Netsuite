...
{    
  try
  {
    ...
    {                               
      ...
      /************************ Added by Yagya on 30/11/2017 for PP-309 ***************/
      ...
      if(file_id)		
      {
        ...
        if(file_url && name)
        {
          //file_url = 'https://system.na3.netsuite.com'+file_url+'|'+name;
          nlapiLogExecution('debug','file_url',file_url);
        }
      }
      /************************ End by Yagya on 30/11/2017 for PP-309***************/
      var objJSON = 
          {
            "po_id" : poId,
            ...
            "attachment_url" : file_url, //Added by Yagya on 30/11/2017 for PP-309
            "script_id" : scriptId,
