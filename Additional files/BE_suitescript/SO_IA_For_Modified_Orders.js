function SO_IA_Chk_One_Ring_With_Modifications(order,pages,today,customer_name,currency,email,iaTemp,type)
{
  ...
  nlapiLogExecution("Debug","No Of Rings(1 or 2 or 3 and so on)(Test) Lib File",chk_catOne_catTwo);
  ...
  {
    return  SO_IA_For_Modified_Orders(order,xml,replacementAmountforModifiedOrders,descriptionforModifiedOrders,pages,today,customer_name,currency,email,iaTemp,type);
  }
  else 
    return '';
}
function SO_IA_For_Modified_Orders(order,xml,replacementAmountforModifiedOrders,descriptionforModifiedOrders,pages,today,customer_name,currency,email,iaTemp,type)
{
  var title ='';
  var disclaimer ='';
