...
{
    //var invoiceNo = "PGD-SA-1617-752"; 
    //var invoiceNo = "PGD-SA-1617-747";
    var invoiceNo = "PGD-SA-1617-788";
	var pos = [];
	var items = [];
	var cdp_item_map = [];
	...
	{
        nlapiLogExecution("debug","search record length",searchRecords2.length);
        ...
        nlapiLogExecution("debug","invoice date is :",invoiceDate);
		...
		for(var i=0; i< searchRecords2.length; i++)
		{
            ...
            nlapiLogExecution("debug","foo value is :",foo);
			if(foo == 0)
			{
