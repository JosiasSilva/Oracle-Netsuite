function  Radiant_Shape_1(meleeSize,subItem1,parentID,gemCount,parentItemId,centerSize,qty1,subItem01,meleeItem)
{
...
function  Radiant_Shape_2(meleeSize,subItem2,parentID,gemCount,parentItemId,centerSize,qty2,subItem02,meleeItem)
{
...
function  Radiant_Shape_3(meleeSize,subItem3,parentID,gemCount,parentItemId,centerSize,qty3,subItem03,meleeItem)
{
...
function  Radiant_Shape_4(meleeSize,subItem4,parentID,gemCount,parentItemId,centerSize,qty4,subItem04,meleeItem)
{
...
function  Radiant_Shape_5(meleeSize,subItem5,parentID,gemCount,parentItemId,centerSize,qty5,subItem05,meleeItem)
{
...
function  Radiant_Shape_6(meleeSize,subItem6,parentID,gemCount,parentItemId,centerSize,qty6,subItem06,meleeItem)
{
...
function  Radiant_Shape_7(meleeSize,subItem7,parentID,gemCount,parentItemId,centerSize,qty7,subItem07,meleeItem)
{
...
function Radiant_Stock_Unit_1(subItem01,parentID,subItem1,stockUnit,searchResult)
{
  nlapiLogExecution("debug","Dynamic stock unit 1 for Radiant");     
  var myStockUnitStr= nlapiLookupField("item",subItem01,"stockunit",true);
  stockUnit=myStockUnitStr.split(' ')[0];
  update_stockUnitDynamically(parentID,stockUnit,subItem1,searchResult);
}
function Radiant_Stock_Unit_2(subItem02,parentID,subItem2,stockUnit,searchResult)
{
  nlapiLogExecution("debug","Dynamic stock unit 2 for Radiant");     
  var myStockUnitStr= nlapiLookupField("item",subItem02,"stockunit",true);
  stockUnit=myStockUnitStr.split(' ')[0];
  update_stockUnitDynamically(parentID,stockUnit,subItem2,searchResult);
}
function Radiant_Stock_Unit_3(subItem03,parentID,subItem3,stockUnit,searchResult)
{
  nlapiLogExecution("debug","Dynamic stock unit 3 for Radiant");     
  var myStockUnitStr= nlapiLookupField("item",subItem03,"stockunit",true);
  stockUnit=myStockUnitStr.split(' ')[0];
  update_stockUnitDynamically(parentID,stockUnit,subItem3,searchResult);
}
function Radiant_Stock_Unit_4(subItem04,parentID,subItem4,stockUnit,searchResult)
{
  nlapiLogExecution("debug","Dynamic stock unit 4 for Radiant");     
  var myStockUnitStr= nlapiLookupField("item",subItem04,"stockunit",true);  
  stockUnit=myStockUnitStr.split(' ')[0];
  update_stockUnitDynamically(parentID,stockUnit,subItem4,searchResult);
}
function Radiant_Stock_Unit_5(subItem05,parentID,subItem5,stockUnit,searchResult)
{
  nlapiLogExecution("debug","Dynamic stock unit 5 for Radiant");     
  var myStockUnitStr= nlapiLookupField("item",subItem05,"stockunit",true); 
  stockUnit=myStockUnitStr.split(' ')[0];
  update_stockUnitDynamically(parentID,stockUnit,subItem5,searchResult);
}
function Radiant_Stock_Unit_6(subItem06,parentID,subItem6,stockUnit,searchResult)
{
  nlapiLogExecution("debug","Dynamic stock unit 6 for Radiant");     
  var myStockUnitStr= nlapiLookupField("item",subItem06,"stockunit",true);
  stockUnit=myStockUnitStr.split(' ')[0];
  update_stockUnitDynamically(parentID,stockUnit,subItem6,searchResult);
}
function Radiant_Stock_Unit_7(subItem07,parentID,subItem7,stockUnit,searchResult)
{
  nlapiLogExecution("debug","Dynamic stock unit 7 for Radiant");     
  var myStockUnitStr= nlapiLookupField("item",subItem07,"stockunit",true);  
  stockUnit=myStockUnitStr.split(' ')[0];
