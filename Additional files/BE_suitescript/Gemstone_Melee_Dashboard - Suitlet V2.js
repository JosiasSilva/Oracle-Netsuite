...
function Use_Java_Script(form) {
  ...
  //Priti
  fieldValue += "else if (this.name=='nextcustpage_posidx')";
  fieldValue += "{elementHighlight='custpage_highlight_po';}";
  ...
  fieldValue +=" } ";
  //Priti
    fieldValue +="else if (jQuery(this).val() == 'green') {";
  fieldValue +="jQuery(this).parent().parent().children().each(function() {";
  fieldValue +="jQuery(this).style('background-color', '#ccffcc', 'important');";
  fieldValue +="});";
