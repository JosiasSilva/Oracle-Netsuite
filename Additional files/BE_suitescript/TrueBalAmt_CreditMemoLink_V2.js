		...
		try{
		    ...
		    var count=salesObj.getLineItemCount('item');
					...
					{  
						...
						//nlapiSubmitField("salesorder",soId,["custbody_truebalanceamount","custbody_truebalanceadjustment","custbody_website_truebalance_amt"], [currencySymbol+" "+numberWithCommas(trueBalanceAmt),TrueBalAdjustAmount,trueBalanceAmt]);
