function Exchange_Page(request,response)
{
	...
	else
	{
		...
		try
		{
					...
					if(results)
					{
						...
						if(results)
						{
							...
							if(results)
							{
								...
								newOrder.setFieldValue("tranid",so_number);
							}
							else
								newOrder.setFieldValue("tranid",so_number);
						}
			...
			{
				newOrder.setFieldValue("shipcountry","US");
				newOrder.setFieldValue("shipaddressee","Pick-up at BE");
				newOrder.setFieldValue("shipaddr1","26 O'Farrell Street, Floor 10");
				newOrder.setFieldValue("shipaddr2","");
				newOrder.setFieldValue("shipcountry","US");
				newOrder.setFieldValue("shipcity","San Francisco");
				newOrder.setFieldValue("shipstate","CA");
				newOrder.setFieldValue("shipzip","94108");
				newOrder.setFieldValue("shipaddress","Pick-up at BE\nSan Francisco, CA 94108\nUnited States");
			}	
