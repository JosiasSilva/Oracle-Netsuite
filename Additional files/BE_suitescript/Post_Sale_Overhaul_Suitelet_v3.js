  ...
  try
  {
    ...
    if(request.getMethod() == 'GET')
    {
      if(backdataUrl == "false")
      {
		...
		var dropOffField = form.addField("custpage_drop_off", "select", "Drop Off", 'customlist_drop_off', "shipaddress");
		dropOffField.setMandatory(true);
      ...
      if(backdataUrl=="true")
      {
        ...
        if(soId !=null && soId !='')
        {
          ...
          {
			Repair_Landing_Page(soRec, soId, dropOff);
          }
    ...
    else if(request.getMethod() == 'POST')
    {
      ...
      if(soId !=null && soId !='')
      {
		...
		ctx.setSessionObject("dropOff", dropOff);
		/* End: NS-1363 - Oct 08, 2018 - Nikhil */
...
function  Order_Delivery_Information()
{
  ...
  var repairNotes = request.getParameter("custpage_repair_notes"); /* Added: NS-1363 - Oct 08, 2018 - Nikhil */
  var repInComm = request.getParameter("custpage_rep_in_comm"); /* Added: NS-1363 - Oct 08, 2018 - Nikhil */
  ...
  retObj.repairNotes = repairNotes; /* Added: NS-1363 - Oct 08, 2018 - Nikhil */
  retObj.repInComm = repInComm; /* Added: NS-1363 - Oct 27, 2018 - Nikhil */
