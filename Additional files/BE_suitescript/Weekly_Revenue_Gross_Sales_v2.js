...
function Bar_Graph_Weekly_Revenue(request,response)
{
	try
	{
	...
	try
	{
		...
		graphCode += "chart.draw(data,{width:700,height:400,title:'Weekly Revenue By Sales Rep (" + startDate + " - " + endDate + ") - $" + totalRevenue + "',hAxis:{title:'Sales Rep',format:'###,###.##',slantedTextAngle:90},legend:'none',tooltipTextStyle:{color: 'black',fontName: 'Arial',fontSize:11}});"
		graphCode += "}"
