function Drop_Ship_Date_Sync(type)
{
	if(type=="create" || type=="edit" || type=="xedit")
	{
		try
		{
			...
			{
				//Only execute for production vendors: USNY, CH, Miracleworks, Trung, Harout
				var vendor = nlapiGetNewRecord().getFieldValue("entity");
				if(vendor!="7773" && vendor!="153" && vendor!="442500" && vendor!="46063" && vendor!="1223843")
				{
					nlapiLogExecution("debug","Not a production vendor. Script will exit.");
					return true;
				}
			...
			else if(type=="xedit")
			{
				...
				{
					//Only execute for production vendors: USNY, CH, Miracleworks, Trung, Harout
					var vendor = nlapiLookupField("purchaseorder",recid,"entity");
					if(vendor!="7773" && vendor!="153" && vendor!="442500" && vendor!="46063" && vendor!="1223843")
					{
						nlapiLogExecution("debug","Not a production vendor. Script will exit.");
						return true;
