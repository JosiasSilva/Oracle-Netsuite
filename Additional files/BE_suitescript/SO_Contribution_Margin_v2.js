...
function setContributionMargin(soID)
{
	...
	try
	{
		...
		for(var x=0; x < lineItems.length; x++)
		{
			...
			else
			{
				...
				{
					nlapiLogExecution("error","Script Execution","PO Status: " + lineItems[x]["po_status"])
	...
	try
	{
		...
		nlapiLogExecution("error","Script Execution (DEBUG)","Calculated contribution margin: " + contributionMargin)
	}
	catch(err)
	{
