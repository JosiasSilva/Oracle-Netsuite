function SignNow_Send_SS()
{
	...
	if(results)
	{
		...
		for(var x=0; x < results.length; x++)
		{
			...
			nlapiSendEmail("20561",results[x].getValue("custrecord_signnow_customer"),"Your Brilliant Earth Return Shipment - Information Needed",mergeResult.getBody(),null,null,records,attachments,false);
