...
function True_Balance_Calculation(salesObj)
{
		...
		var  totalAmount = 0,totalDiscount=0,discAmount=0,netDiscAmount=0, taxAmt=0,totalTaxAmt=0,totalShipCost=0,taxrate=0,trueBalanceAmt=0;
		...
		for(var i=1; i<=salesObj.getLineItemCount('item');i++)
		{						 
