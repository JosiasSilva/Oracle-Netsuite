...
function getKPIURL(searchColumn, searchId, rptType) {
    ...
    var urlCurrYM = "https://system.netsuite.com/app/common/search/searchresults.nl?searchid=" + searchId + "&kpi=T&" + searchColumn + "=" + rptType + "&" + searchColumn + "modi=WITHIN&detail=" + searchColumn;
    return urlCurrYM;
}
